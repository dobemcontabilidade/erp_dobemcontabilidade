...
import { sampleWithRequiredData } from '../plano-conta-azul.test-samples';
...
describe('PlanoContaAzul Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [PlanoContaAzulComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.planoContaAzuls?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to planoContaAzulService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPlanoContaAzulIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPlanoContaAzulIdentifier).toHaveBeenCalledWith(entity);
