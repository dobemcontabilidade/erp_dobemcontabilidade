...
describe('DepartamentoEmpresa Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Departamento query and add missing value', () => {
      ...
      const departamento: IDepartamento = { id: 22733 };
      departamentoEmpresa.departamento = departamento;

      const departamentoCollection: IDepartamento[] = [{ id: 31249 }];
    ...
    it('Should call Empresa query and add missing value', () => {
      const departamentoEmpresa: IDepartamentoEmpresa = { id: 456 };
      const empresa: IEmpresa = { id: 15361 };
      departamentoEmpresa.empresa = empresa;

      const empresaCollection: IEmpresa[] = [{ id: 8154 }];
    ...
    it('Should call Contador query and add missing value', () => {
      const departamentoEmpresa: IDepartamentoEmpresa = { id: 456 };
      const contador: IContador = { id: 436 };
      departamentoEmpresa.contador = contador;

      const contadorCollection: IContador[] = [{ id: 31998 }];
    ...
    it('Should update editForm', () => {
      const departamentoEmpresa: IDepartamentoEmpresa = { id: 456 };
      const departamento: IDepartamento = { id: 24321 };
      departamentoEmpresa.departamento = departamento;
      const empresa: IEmpresa = { id: 25277 };
      departamentoEmpresa.empresa = empresa;
      const contador: IContador = { id: 15440 };
      departamentoEmpresa.contador = contador;
