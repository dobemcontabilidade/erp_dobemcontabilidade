...
import { sampleWithRequiredData } from '../telefone.test-samples';
...
describe('Telefone Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to telefoneService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTelefoneIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTelefoneIdentifier).toHaveBeenCalledWith(entity);
