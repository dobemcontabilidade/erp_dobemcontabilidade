...
import { sampleWithRequiredData } from '../forma-de-pagamento.test-samples';
...
describe('FormaDePagamento Management Component', () => {
  let comp: FormaDePagamentoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [FormaDePagamentoComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(FormaDePagamentoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.formaDePagamentos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to formaDePagamentoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFormaDePagamentoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFormaDePagamentoIdentifier).toHaveBeenCalledWith(entity);
