...
import { sampleWithRequiredData } from '../desconto-plano-contabil.test-samples';
...
describe('DescontoPlanoContabil Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [DescontoPlanoContabilComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.descontoPlanoContabils?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to descontoPlanoContabilService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDescontoPlanoContabilIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDescontoPlanoContabilIdentifier).toHaveBeenCalledWith(entity);
