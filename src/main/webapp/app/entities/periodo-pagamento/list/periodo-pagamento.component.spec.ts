...
import { sampleWithRequiredData } from '../periodo-pagamento.test-samples';
...
describe('PeriodoPagamento Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [PeriodoPagamentoComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.periodoPagamentos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to periodoPagamentoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPeriodoPagamentoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPeriodoPagamentoIdentifier).toHaveBeenCalledWith(entity);
