...
import { sampleWithRequiredData } from '../administrador.test-samples';
...
describe('Administrador Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to administradorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAdministradorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAdministradorIdentifier).toHaveBeenCalledWith(entity);
