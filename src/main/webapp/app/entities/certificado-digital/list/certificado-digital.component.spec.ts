...
import { sampleWithRequiredData } from '../certificado-digital.test-samples';
...
describe('CertificadoDigital Management Component', () => {
  let comp: CertificadoDigitalComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [CertificadoDigitalComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(CertificadoDigitalComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.certificadoDigitals?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to certificadoDigitalService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCertificadoDigitalIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCertificadoDigitalIdentifier).toHaveBeenCalledWith(entity);
