      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            reintegrado: expect.any(Object),
            primeiroEmprego: expect.any(Object),
            multiploVinculos: expect.any(Object),
            dataOpcaoFgts: expect.any(Object),
            filiacaoSindical: expect.any(Object),
            cnpjSindicato: expect.any(Object),
            tipoFuncionarioEnum: expect.any(Object),
