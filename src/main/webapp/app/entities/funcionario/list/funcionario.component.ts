...
import { EntityArrayResponseType, FuncionarioService } from '../service/funcionario.service';
...
export class FuncionarioComponent implements OnInit {
  ...
  trackId = (_index: number, item: IFuncionario): number => this.funcionarioService.getFuncionarioIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.funcionarios = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IFuncionario[] | null): IFuncionario[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.funcionarioService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
