...
type EmpresaFormDefaults = Pick<NewEmpresa, 'id' | 'dataAbertura' | 'segmentoCnaes'>;
...
type EmpresaFormGroupContent = {
  ...
  segmentoCnaes: FormControl<EmpresaFormRawValue['segmentoCnaes']>;
  empresaModelo: FormControl<EmpresaFormRawValue['empresaModelo']>;
};
...
export class EmpresaFormService {
  createEmpresaFormGroup(empresa: EmpresaFormGroupInput = { id: null }): EmpresaFormGroup {
    ...
    return new FormGroup<EmpresaFormGroupContent>({
      ...
      segmentoCnaes: new FormControl(empresaRawValue.segmentoCnaes ?? []),
      empresaModelo: new FormControl(empresaRawValue.empresaModelo, {
        validators: [Validators.required],
      }),
    });
  }
  ...
  private convertEmpresaToEmpresaRawValue(
    ...
    return {
      ...
      segmentoCnaes: empresa.segmentoCnaes ?? [],
    };
  }
}
