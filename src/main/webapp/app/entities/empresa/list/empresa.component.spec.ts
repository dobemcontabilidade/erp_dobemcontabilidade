...
import { sampleWithRequiredData } from '../empresa.test-samples';
...
describe('Empresa Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to empresaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEmpresaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEmpresaIdentifier).toHaveBeenCalledWith(entity);
