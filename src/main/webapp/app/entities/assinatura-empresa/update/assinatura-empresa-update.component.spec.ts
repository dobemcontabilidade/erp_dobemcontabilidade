...
describe('AssinaturaEmpresa Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call PeriodoPagamento query and add missing value', () => {
      ...
      const periodoPagamento: IPeriodoPagamento = { id: 20117 };
      assinaturaEmpresa.periodoPagamento = periodoPagamento;

      const periodoPagamentoCollection: IPeriodoPagamento[] = [{ id: 21923 }];
    ...
    it('Should call FormaDePagamento query and add missing value', () => {
      const assinaturaEmpresa: IAssinaturaEmpresa = { id: 456 };
      const formaDePagamento: IFormaDePagamento = { id: 7250 };
      assinaturaEmpresa.formaDePagamento = formaDePagamento;

      const formaDePagamentoCollection: IFormaDePagamento[] = [{ id: 1138 }];
    ...
    it('Should call Empresa query and add missing value', () => {
      const assinaturaEmpresa: IAssinaturaEmpresa = { id: 456 };
      const empresa: IEmpresa = { id: 5510 };
      assinaturaEmpresa.empresa = empresa;

      const empresaCollection: IEmpresa[] = [{ id: 20321 }];
    ...
    it('Should update editForm', () => {
      const assinaturaEmpresa: IAssinaturaEmpresa = { id: 456 };
      const periodoPagamento: IPeriodoPagamento = { id: 32340 };
      assinaturaEmpresa.periodoPagamento = periodoPagamento;
      const formaDePagamento: IFormaDePagamento = { id: 19156 };
      assinaturaEmpresa.formaDePagamento = formaDePagamento;
      const empresa: IEmpresa = { id: 30955 };
      assinaturaEmpresa.empresa = empresa;
