...
describe('AssinaturaEmpresa Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call PeriodoPagamento query and add missing value', () => {
      ...
      const periodoPagamento: IPeriodoPagamento = { id: 1445 };
      assinaturaEmpresa.periodoPagamento = periodoPagamento;

      const periodoPagamentoCollection: IPeriodoPagamento[] = [{ id: 10247 }];
    ...
    it('Should call FormaDePagamento query and add missing value', () => {
      const assinaturaEmpresa: IAssinaturaEmpresa = { id: 456 };
      const formaDePagamento: IFormaDePagamento = { id: 15849 };
      assinaturaEmpresa.formaDePagamento = formaDePagamento;

      const formaDePagamentoCollection: IFormaDePagamento[] = [{ id: 12519 }];
    ...
    it('Should call PlanoContaAzul query and add missing value', () => {
      const assinaturaEmpresa: IAssinaturaEmpresa = { id: 456 };
      const planoContaAzul: IPlanoContaAzul = { id: 19719 };
      assinaturaEmpresa.planoContaAzul = planoContaAzul;

      const planoContaAzulCollection: IPlanoContaAzul[] = [{ id: 2546 }];
    ...
    it('Should call PlanoContabil query and add missing value', () => {
      const assinaturaEmpresa: IAssinaturaEmpresa = { id: 456 };
      const planoContabil: IPlanoContabil = { id: 16100 };
      assinaturaEmpresa.planoContabil = planoContabil;

      const planoContabilCollection: IPlanoContabil[] = [{ id: 13175 }];
    ...
    it('Should call Empresa query and add missing value', () => {
      const assinaturaEmpresa: IAssinaturaEmpresa = { id: 456 };
      const empresa: IEmpresa = { id: 10706 };
      assinaturaEmpresa.empresa = empresa;

      const empresaCollection: IEmpresa[] = [{ id: 7283 }];
    ...
    it('Should update editForm', () => {
      const assinaturaEmpresa: IAssinaturaEmpresa = { id: 456 };
      const periodoPagamento: IPeriodoPagamento = { id: 3829 };
      assinaturaEmpresa.periodoPagamento = periodoPagamento;
      const formaDePagamento: IFormaDePagamento = { id: 26484 };
      assinaturaEmpresa.formaDePagamento = formaDePagamento;
      const planoContaAzul: IPlanoContaAzul = { id: 9598 };
      assinaturaEmpresa.planoContaAzul = planoContaAzul;
      const planoContabil: IPlanoContabil = { id: 9586 };
      assinaturaEmpresa.planoContabil = planoContabil;
      const empresa: IEmpresa = { id: 3332 };
      assinaturaEmpresa.empresa = empresa;
