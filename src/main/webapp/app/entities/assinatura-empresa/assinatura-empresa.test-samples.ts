...
export const sampleWithPartialData: IAssinaturaEmpresa = {
  ...
  valorAno: 13557.2,
  dataContratacao: dayjs('2024-08-09T17:03'),
  dataEncerramento: dayjs('2024-08-09T22:55'),
  diaVencimento: 19529,
...
export const sampleWithFullData: IAssinaturaEmpresa = {
  ...
  valorAno: 5700.03,
  dataContratacao: dayjs('2024-08-10T01:29'),
  dataEncerramento: dayjs('2024-08-09T10:03'),
  diaVencimento: 2924,
  situacao: 'CANCELADO',
  tipoContrato: 'CONTRATACAO_PLANO',
};
