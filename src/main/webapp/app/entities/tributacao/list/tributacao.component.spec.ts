...
import { sampleWithRequiredData } from '../tributacao.test-samples';
import { TributacaoService } from '../service/tributacao.service';

import { TributacaoComponent } from './tributacao.component';
import SpyInstance = jest.SpyInstance;

describe('Tributacao Management Component', () => {
  let comp: TributacaoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TributacaoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tributacaos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to tributacaoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTributacaoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTributacaoIdentifier).toHaveBeenCalledWith(entity);
