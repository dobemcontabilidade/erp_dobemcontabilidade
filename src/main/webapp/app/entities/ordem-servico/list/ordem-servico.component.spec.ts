...
import { sampleWithRequiredData } from '../ordem-servico.test-samples';
...
describe('OrdemServico Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ordemServicos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to ordemServicoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOrdemServicoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOrdemServicoIdentifier).toHaveBeenCalledWith(entity);
