...
import { sampleWithRequiredData } from '../frequencia.test-samples';
import { FrequenciaService } from '../service/frequencia.service';

import { FrequenciaComponent } from './frequencia.component';
import SpyInstance = jest.SpyInstance;

describe('Frequencia Management Component', () => {
  let comp: FrequenciaComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(FrequenciaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.frequencias?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to frequenciaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFrequenciaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFrequenciaIdentifier).toHaveBeenCalledWith(entity);
