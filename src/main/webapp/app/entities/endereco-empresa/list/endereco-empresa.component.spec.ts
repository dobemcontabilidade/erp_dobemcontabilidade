...
import { sampleWithRequiredData } from '../endereco-empresa.test-samples';
...
describe('EnderecoEmpresa Management Component', () => {
  let comp: EnderecoEmpresaComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EnderecoEmpresaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.enderecoEmpresas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to enderecoEmpresaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEnderecoEmpresaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEnderecoEmpresaIdentifier).toHaveBeenCalledWith(entity);
