...
describe('EnderecoEmpresa Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Empresa query and add missing value', () => {
      ...
      const empresa: IEmpresa = { id: 23366 };
      enderecoEmpresa.empresa = empresa;

      const empresaCollection: IEmpresa[] = [{ id: 26080 }];
    ...
    it('Should call Cidade query and add missing value', () => {
      const enderecoEmpresa: IEnderecoEmpresa = { id: 456 };
      const cidade: ICidade = { id: 8219 };
      enderecoEmpresa.cidade = cidade;

      const cidadeCollection: ICidade[] = [{ id: 1763 }];
    ...
    it('Should update editForm', () => {
      const enderecoEmpresa: IEnderecoEmpresa = { id: 456 };
      const empresa: IEmpresa = { id: 20069 };
      enderecoEmpresa.empresa = empresa;
      const cidade: ICidade = { id: 18241 };
      enderecoEmpresa.cidade = cidade;
