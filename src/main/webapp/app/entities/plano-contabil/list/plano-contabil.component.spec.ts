...
import { sampleWithRequiredData } from '../plano-contabil.test-samples';
...
describe('PlanoContabil Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [PlanoContabilComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.planoContabils?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to planoContabilService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPlanoContabilIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPlanoContabilIdentifier).toHaveBeenCalledWith(entity);
