...
import { sampleWithRequiredData } from '../escolaridade.test-samples';
...
describe('Escolaridade Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.escolaridades?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to escolaridadeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEscolaridadeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEscolaridadeIdentifier).toHaveBeenCalledWith(entity);
