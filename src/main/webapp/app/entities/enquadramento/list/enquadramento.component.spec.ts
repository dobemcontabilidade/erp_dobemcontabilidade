...
import { sampleWithRequiredData } from '../enquadramento.test-samples';
...
describe('Enquadramento Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [EnquadramentoComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.enquadramentos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to enquadramentoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEnquadramentoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEnquadramentoIdentifier).toHaveBeenCalledWith(entity);
