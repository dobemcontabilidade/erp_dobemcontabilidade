...
import { sampleWithRequiredData } from '../funcionalidade.test-samples';
...
describe('Funcionalidade Management Component', () => {
  let comp: FuncionalidadeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(FuncionalidadeComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to funcionalidadeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFuncionalidadeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFuncionalidadeIdentifier).toHaveBeenCalledWith(entity);
