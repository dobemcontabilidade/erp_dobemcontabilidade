...
import { sampleWithRequiredData } from '../esfera.test-samples';
import { EsferaService } from '../service/esfera.service';

import { EsferaComponent } from './esfera.component';
import SpyInstance = jest.SpyInstance;

describe('Esfera Management Component', () => {
  let comp: EsferaComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EsferaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.esferas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to esferaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEsferaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEsferaIdentifier).toHaveBeenCalledWith(entity);
