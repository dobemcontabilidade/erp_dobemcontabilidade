...
import { sampleWithRequiredData } from '../rede-social.test-samples';
...
describe('RedeSocial Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.redeSocials?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to redeSocialService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRedeSocialIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRedeSocialIdentifier).toHaveBeenCalledWith(entity);
