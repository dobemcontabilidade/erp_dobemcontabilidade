...
import { sampleWithRequiredData } from '../perfil-acesso.test-samples';
...
describe('PerfilAcesso Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.perfilAcessos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to perfilAcessoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPerfilAcessoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPerfilAcessoIdentifier).toHaveBeenCalledWith(entity);
