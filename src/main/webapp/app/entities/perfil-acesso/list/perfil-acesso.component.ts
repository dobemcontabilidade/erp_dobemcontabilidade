...
import { EntityArrayResponseType, PerfilAcessoService } from '../service/perfil-acesso.service';
import { PerfilAcessoDeleteDialogComponent } from '../delete/perfil-acesso-delete-dialog.component';
...
export class PerfilAcessoComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPerfilAcesso): number => this.perfilAcessoService.getPerfilAcessoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.perfilAcessos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPerfilAcesso[] | null): IPerfilAcesso[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.perfilAcessoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
