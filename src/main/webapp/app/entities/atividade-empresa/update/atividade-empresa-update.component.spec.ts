...
describe('AtividadeEmpresa Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call SubclasseCnae query and add missing value', () => {
      ...
      const cnae: ISubclasseCnae = { id: 6585 };
      atividadeEmpresa.cnae = cnae;

      const subclasseCnaeCollection: ISubclasseCnae[] = [{ id: 10367 }];
    ...
    it('Should call Empresa query and add missing value', () => {
      const atividadeEmpresa: IAtividadeEmpresa = { id: 456 };
      const empresa: IEmpresa = { id: 7371 };
      atividadeEmpresa.empresa = empresa;

      const empresaCollection: IEmpresa[] = [{ id: 30113 }];
    ...
    it('Should update editForm', () => {
      const atividadeEmpresa: IAtividadeEmpresa = { id: 456 };
      const cnae: ISubclasseCnae = { id: 25674 };
      atividadeEmpresa.cnae = cnae;
      const empresa: IEmpresa = { id: 4345 };
      atividadeEmpresa.empresa = empresa;
