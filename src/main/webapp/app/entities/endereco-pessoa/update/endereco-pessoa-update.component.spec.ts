...
describe('EnderecoPessoa Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Pessoa query and add missing value', () => {
      ...
      const pessoa: IPessoa = { id: 11973 };
      enderecoPessoa.pessoa = pessoa;

      const pessoaCollection: IPessoa[] = [{ id: 12185 }];
    ...
    it('Should call Cidade query and add missing value', () => {
      const enderecoPessoa: IEnderecoPessoa = { id: 456 };
      const cidade: ICidade = { id: 881 };
      enderecoPessoa.cidade = cidade;

      const cidadeCollection: ICidade[] = [{ id: 27488 }];
    ...
    it('Should update editForm', () => {
      const enderecoPessoa: IEnderecoPessoa = { id: 456 };
      const pessoa: IPessoa = { id: 12568 };
      enderecoPessoa.pessoa = pessoa;
      const cidade: ICidade = { id: 29349 };
      enderecoPessoa.cidade = cidade;
