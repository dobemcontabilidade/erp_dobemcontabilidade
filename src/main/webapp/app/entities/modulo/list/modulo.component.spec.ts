...
import { sampleWithRequiredData } from '../modulo.test-samples';
...
describe('Modulo Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.modulos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to moduloService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getModuloIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getModuloIdentifier).toHaveBeenCalledWith(entity);
