...
import { EntityArrayResponseType, TarefaService } from '../service/tarefa.service';
...
export class TarefaComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITarefa): number => this.tarefaService.getTarefaIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.tarefas = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ITarefa[] | null): ITarefa[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.tarefaService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
