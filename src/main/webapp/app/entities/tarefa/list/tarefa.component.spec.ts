...
import { sampleWithRequiredData } from '../tarefa.test-samples';
...
describe('Tarefa Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tarefas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to tarefaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTarefaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTarefaIdentifier).toHaveBeenCalledWith(entity);
