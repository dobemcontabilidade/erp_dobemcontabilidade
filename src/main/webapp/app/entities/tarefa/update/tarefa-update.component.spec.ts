...
describe('Tarefa Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Esfera query and add missing value', () => {
      ...
      const esfera: IEsfera = { id: 23035 };
      tarefa.esfera = esfera;

      const esferaCollection: IEsfera[] = [{ id: 21066 }];
    ...
    it('Should call Frequencia query and add missing value', () => {
      const tarefa: ITarefa = { id: 456 };
      const frequencia: IFrequencia = { id: 13500 };
      tarefa.frequencia = frequencia;

      const frequenciaCollection: IFrequencia[] = [{ id: 29700 }];
    ...
    it('Should call Competencia query and add missing value', () => {
      const tarefa: ITarefa = { id: 456 };
      const competencia: ICompetencia = { id: 11900 };
      tarefa.competencia = competencia;

      const competenciaCollection: ICompetencia[] = [{ id: 26140 }];
    ...
    it('Should update editForm', () => {
      const tarefa: ITarefa = { id: 456 };
      const esfera: IEsfera = { id: 5050 };
      tarefa.esfera = esfera;
      const frequencia: IFrequencia = { id: 25023 };
      tarefa.frequencia = frequencia;
      const competencia: ICompetencia = { id: 15133 };
      tarefa.competencia = competencia;
