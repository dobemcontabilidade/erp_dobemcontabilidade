...
import { EntityArrayResponseType, ProfissaoService } from '../service/profissao.service';
import { ProfissaoDeleteDialogComponent } from '../delete/profissao-delete-dialog.component';
...
export class ProfissaoComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProfissao): number => this.profissaoService.getProfissaoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.profissaos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IProfissao[] | null): IProfissao[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.profissaoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
