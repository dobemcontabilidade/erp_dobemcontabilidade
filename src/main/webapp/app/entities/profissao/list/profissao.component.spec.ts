...
import { sampleWithRequiredData } from '../profissao.test-samples';
...
describe('Profissao Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.profissaos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to profissaoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProfissaoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProfissaoIdentifier).toHaveBeenCalledWith(entity);
