...
type UsuarioEmpresaFormDefaults = Pick<NewUsuarioEmpresa, 'id' | 'ativo' | 'dataHoraAtivacao' | 'dataLimiteAcesso'>;
...
type UsuarioEmpresaFormGroupContent = {
  ...
  ativo: FormControl<UsuarioEmpresaFormRawValue['ativo']>;
  ...
  situacaoUsuarioEmpresa: FormControl<UsuarioEmpresaFormRawValue['situacaoUsuarioEmpresa']>;
  tipoUsuarioEmpresaEnum: FormControl<UsuarioEmpresaFormRawValue['tipoUsuarioEmpresaEnum']>;
  assinaturaEmpresa: FormControl<UsuarioEmpresaFormRawValue['assinaturaEmpresa']>;
};
...
export class UsuarioEmpresaFormService {
  createUsuarioEmpresaFormGroup(usuarioEmpresa: UsuarioEmpresaFormGroupInput = { id: null }): UsuarioEmpresaFormGroup {
    ...
    return new FormGroup<UsuarioEmpresaFormGroupContent>({
      ...
      ativo: new FormControl(usuarioEmpresaRawValue.ativo),
      ...
      situacaoUsuarioEmpresa: new FormControl(usuarioEmpresaRawValue.situacaoUsuarioEmpresa),
      tipoUsuarioEmpresaEnum: new FormControl(usuarioEmpresaRawValue.tipoUsuarioEmpresaEnum),
      assinaturaEmpresa: new FormControl(usuarioEmpresaRawValue.assinaturaEmpresa, {
        validators: [Validators.required],
      }),
    });
  }
