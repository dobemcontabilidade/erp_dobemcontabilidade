...
import { sampleWithRequiredData } from '../usuario-empresa.test-samples';
...
describe('UsuarioEmpresa Management Component', () => {
  let comp: UsuarioEmpresaComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [UsuarioEmpresaComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(UsuarioEmpresaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.usuarioEmpresas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to usuarioEmpresaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getUsuarioEmpresaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getUsuarioEmpresaIdentifier).toHaveBeenCalledWith(entity);
