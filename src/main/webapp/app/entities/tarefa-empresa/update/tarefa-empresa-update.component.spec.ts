...
describe('TarefaEmpresa Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Empresa query and add missing value', () => {
      ...
      const empresa: IEmpresa = { id: 23789 };
      tarefaEmpresa.empresa = empresa;

      const empresaCollection: IEmpresa[] = [{ id: 21411 }];
    ...
    it('Should call Contador query and add missing value', () => {
      const tarefaEmpresa: ITarefaEmpresa = { id: 456 };
      const contador: IContador = { id: 26732 };
      tarefaEmpresa.contador = contador;

      const contadorCollection: IContador[] = [{ id: 26947 }];
    ...
    it('Should call Tarefa query and add missing value', () => {
      const tarefaEmpresa: ITarefaEmpresa = { id: 456 };
      const tarefa: ITarefa = { id: 22253 };
      tarefaEmpresa.tarefa = tarefa;

      const tarefaCollection: ITarefa[] = [{ id: 4340 }];
    ...
    it('Should update editForm', () => {
      const tarefaEmpresa: ITarefaEmpresa = { id: 456 };
      const empresa: IEmpresa = { id: 11278 };
      tarefaEmpresa.empresa = empresa;
      const contador: IContador = { id: 29605 };
      tarefaEmpresa.contador = contador;
      const tarefa: ITarefa = { id: 3807 };
      tarefaEmpresa.tarefa = tarefa;
