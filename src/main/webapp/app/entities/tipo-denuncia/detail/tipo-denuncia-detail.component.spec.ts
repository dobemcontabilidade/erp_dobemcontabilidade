...
describe('TipoDenuncia Management Detail Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TipoDenunciaDetailComponent],
      providers: [
        provideRouter(
          [
            {
              ...
              resolve: { tipoDenuncia: () => of({ id: 123 }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load tipoDenuncia on init', async () => {
      const harness = await RouterTestingHarness.create();
      const instance = await harness.navigateByUrl('/', TipoDenunciaDetailComponent);

      // THEN
      expect(instance.tipoDenuncia()).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
