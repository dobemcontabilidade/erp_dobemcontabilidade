...
describe('Cnae Management Detail Component', () => {
  ...
  describe('OnInit', () => {
    it('Should load cnae on init', async () => {
      const harness = await RouterTestingHarness.create();
      const instance = await harness.navigateByUrl('/', CnaeDetailComponent);

      // THEN
      expect(instance.cnae()).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
