...
import { sampleWithRequiredData } from '../cnae.test-samples';
...
describe('Cnae Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cnaes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to cnaeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCnaeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCnaeIdentifier).toHaveBeenCalledWith(entity);
