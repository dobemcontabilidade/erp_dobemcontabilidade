...
import estadoResolve from './estado-routing-resolve.service';

describe('Estado routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: EstadoService;
  let resultEstado: IEstado | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IEstado returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        estadoResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultEstado = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEstado).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEstado>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
