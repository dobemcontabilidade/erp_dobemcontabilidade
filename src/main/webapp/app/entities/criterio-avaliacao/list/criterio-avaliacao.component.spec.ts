...
import { sampleWithRequiredData } from '../criterio-avaliacao.test-samples';
...
describe('CriterioAvaliacao Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [CriterioAvaliacaoComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.criterioAvaliacaos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to criterioAvaliacaoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCriterioAvaliacaoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCriterioAvaliacaoIdentifier).toHaveBeenCalledWith(entity);
