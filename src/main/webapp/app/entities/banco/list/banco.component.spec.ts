...
import { sampleWithRequiredData } from '../banco.test-samples';
...
describe('Banco Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bancos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to bancoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBancoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBancoIdentifier).toHaveBeenCalledWith(entity);
