...
import { sampleWithRequiredData } from '../ramo.test-samples';
...
describe('Ramo Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ramos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to ramoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRamoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRamoIdentifier).toHaveBeenCalledWith(entity);
