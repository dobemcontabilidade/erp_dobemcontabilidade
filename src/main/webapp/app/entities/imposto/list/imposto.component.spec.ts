...
import { sampleWithRequiredData } from '../imposto.test-samples';
...
describe('Imposto Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to impostoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getImpostoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getImpostoIdentifier).toHaveBeenCalledWith(entity);
