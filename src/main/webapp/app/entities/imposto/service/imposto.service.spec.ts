...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../imposto.test-samples';

import { ImpostoService } from './imposto.service';

const requireRestSample: IImposto = {
...
describe('Imposto Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Imposto', () => {
      const imposto = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(imposto).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Imposto', () => {
      const imposto = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(imposto).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addImpostoToCollectionIfMissing', () => {
      it('should add a Imposto to an empty array', () => {
        const imposto: IImposto = sampleWithRequiredData;
      ...
      it("should add a Imposto to an array that doesn't contain it", () => {
        const imposto: IImposto = sampleWithRequiredData;
        const impostoCollection: IImposto[] = [sampleWithPartialData];
        expectedResult = service.addImpostoToCollectionIfMissing(impostoCollection, imposto);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(imposto);
      });
      ...
      it('should add only unique Imposto to an array', () => {
        const impostoArray: IImposto[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const impostoCollection: IImposto[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const imposto: IImposto = sampleWithRequiredData;
        const imposto2: IImposto = sampleWithPartialData;
    ...
    describe('compareImposto', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareImposto(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareImposto(entity1, entity2);
        const compareResult2 = service.compareImposto(entity2, entity1);
