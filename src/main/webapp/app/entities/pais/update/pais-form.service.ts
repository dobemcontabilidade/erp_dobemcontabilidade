...
type PaisFormGroupContent = {
  ...
  nome: FormControl<IPais['nome']>;
  nacionalidade: FormControl<IPais['nacionalidade']>;
  sigla: FormControl<IPais['sigla']>;
};
...
export class PaisFormService {
  createPaisFormGroup(pais: PaisFormGroupInput = { id: null }): PaisFormGroup {
    ...
    return new FormGroup<PaisFormGroupContent>({
      ...
      nome: new FormControl(paisRawValue.nome),
      nacionalidade: new FormControl(paisRawValue.nacionalidade),
      sigla: new FormControl(paisRawValue.sigla),
    });
  }
