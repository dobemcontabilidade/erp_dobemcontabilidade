...
import { sampleWithRequiredData } from '../instituicao-ensino.test-samples';
...
describe('InstituicaoEnsino Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [InstituicaoEnsinoComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.instituicaoEnsinos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to instituicaoEnsinoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInstituicaoEnsinoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInstituicaoEnsinoIdentifier).toHaveBeenCalledWith(entity);
