...
@Component({
  standalone: true,
  templateUrl: './anexo-servico-contabil-empresa-delete-dialog.component.html',
  imports: [SharedModule, FormsModule],
})
export class AnexoServicoContabilEmpresaDeleteDialogComponent {
  anexoServicoContabilEmpresa?: IAnexoServicoContabilEmpresa;
  ...
  confirmDelete(id: number): void {
    this.anexoServicoContabilEmpresaService.delete(id).subscribe(() => {
