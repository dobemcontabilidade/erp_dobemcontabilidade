...
describe('CalculoPlanoAssinatura Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call PeriodoPagamento query and add missing value', () => {
      ...
      const periodoPagamento: IPeriodoPagamento = { id: 17799 };
      calculoPlanoAssinatura.periodoPagamento = periodoPagamento;

      const periodoPagamentoCollection: IPeriodoPagamento[] = [{ id: 1943 }];
    ...
    it('Should call PlanoContaAzul query and add missing value', () => {
      const calculoPlanoAssinatura: ICalculoPlanoAssinatura = { id: 456 };
      const planoContaAzul: IPlanoContaAzul = { id: 1249 };
      calculoPlanoAssinatura.planoContaAzul = planoContaAzul;

      const planoContaAzulCollection: IPlanoContaAzul[] = [{ id: 25038 }];
    ...
    it('Should call PlanoContabil query and add missing value', () => {
      const calculoPlanoAssinatura: ICalculoPlanoAssinatura = { id: 456 };
      const planoContabil: IPlanoContabil = { id: 31780 };
      calculoPlanoAssinatura.planoContabil = planoContabil;

      const planoContabilCollection: IPlanoContabil[] = [{ id: 6848 }];
    ...
    it('Should call Ramo query and add missing value', () => {
      const calculoPlanoAssinatura: ICalculoPlanoAssinatura = { id: 456 };
      const ramo: IRamo = { id: 7955 };
      calculoPlanoAssinatura.ramo = ramo;

      const ramoCollection: IRamo[] = [{ id: 4766 }];
    ...
    it('Should call Tributacao query and add missing value', () => {
      const calculoPlanoAssinatura: ICalculoPlanoAssinatura = { id: 456 };
      const tributacao: ITributacao = { id: 18576 };
      calculoPlanoAssinatura.tributacao = tributacao;

      const tributacaoCollection: ITributacao[] = [{ id: 16642 }];
    ...
    it('Should call DescontoPlanoContabil query and add missing value', () => {
      const calculoPlanoAssinatura: ICalculoPlanoAssinatura = { id: 456 };
      const descontoPlanoContabil: IDescontoPlanoContabil = { id: 3083 };
      calculoPlanoAssinatura.descontoPlanoContabil = descontoPlanoContabil;

      const descontoPlanoContabilCollection: IDescontoPlanoContabil[] = [{ id: 20634 }];
    ...
    it('Should call DescontoPlanoContaAzul query and add missing value', () => {
      const calculoPlanoAssinatura: ICalculoPlanoAssinatura = { id: 456 };
      const descontoPlanoContaAzul: IDescontoPlanoContaAzul = { id: 7665 };
      calculoPlanoAssinatura.descontoPlanoContaAzul = descontoPlanoContaAzul;

      const descontoPlanoContaAzulCollection: IDescontoPlanoContaAzul[] = [{ id: 25346 }];
    ...
    it('Should call AssinaturaEmpresa query and add missing value', () => {
      const calculoPlanoAssinatura: ICalculoPlanoAssinatura = { id: 456 };
      const assinaturaEmpresa: IAssinaturaEmpresa = { id: 28325 };
      calculoPlanoAssinatura.assinaturaEmpresa = assinaturaEmpresa;

      const assinaturaEmpresaCollection: IAssinaturaEmpresa[] = [{ id: 31291 }];
    ...
    it('Should update editForm', () => {
      const calculoPlanoAssinatura: ICalculoPlanoAssinatura = { id: 456 };
      const periodoPagamento: IPeriodoPagamento = { id: 17742 };
      calculoPlanoAssinatura.periodoPagamento = periodoPagamento;
      const planoContaAzul: IPlanoContaAzul = { id: 25163 };
      calculoPlanoAssinatura.planoContaAzul = planoContaAzul;
      const planoContabil: IPlanoContabil = { id: 28223 };
      calculoPlanoAssinatura.planoContabil = planoContabil;
      const ramo: IRamo = { id: 12521 };
      calculoPlanoAssinatura.ramo = ramo;
      const tributacao: ITributacao = { id: 11424 };
      calculoPlanoAssinatura.tributacao = tributacao;
      const descontoPlanoContabil: IDescontoPlanoContabil = { id: 5311 };
      calculoPlanoAssinatura.descontoPlanoContabil = descontoPlanoContabil;
      const descontoPlanoContaAzul: IDescontoPlanoContaAzul = { id: 13495 };
      calculoPlanoAssinatura.descontoPlanoContaAzul = descontoPlanoContaAzul;
      const assinaturaEmpresa: IAssinaturaEmpresa = { id: 32018 };
      calculoPlanoAssinatura.assinaturaEmpresa = assinaturaEmpresa;
