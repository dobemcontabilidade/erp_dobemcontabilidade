...
public class TelefoneCriteria implements Serializable, Criteria {
    ...
    private BooleanFilter principla;
    ...
    public TelefoneCriteria(TelefoneCriteria other) {
        ...
        this.principla = other.optionalPrincipla().map(BooleanFilter::copy).orElse(null);
    ...
    public BooleanFilter getPrincipla() {
        return principla;
    }

    public Optional<BooleanFilter> optionalPrincipla() {
        return Optional.ofNullable(principla);
    }

    public BooleanFilter principla() {
        if (principla == null) {
            setPrincipla(new BooleanFilter());
        }
        return principla;
    }

    public void setPrincipla(BooleanFilter principla) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(principla, that.principla) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, codigoArea, telefone, principla, tipoTelefone, pessoaId, distinct);
    }
    ...
    public String toString() {
        return "TelefoneCriteria{" +
            ...
            optionalPrincipla().map(f -> "principla=" + f + ", ").orElse("") +
