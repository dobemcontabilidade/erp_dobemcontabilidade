...
/**
 * Criteria class for the {@link com.dobemcontabilidade.domain.OpcaoNomeFantasiaEmpresa} entity. This class is used
 * in {@link com.dobemcontabilidade.web.rest.OpcaoNomeFantasiaEmpresaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /opcao-nome-fantasia-empresas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OpcaoNomeFantasiaEmpresaCriteria implements Serializable, Criteria {
    ...
    public OpcaoNomeFantasiaEmpresaCriteria() {}

    public OpcaoNomeFantasiaEmpresaCriteria(OpcaoNomeFantasiaEmpresaCriteria other) {
    ...
    @Override
    public OpcaoNomeFantasiaEmpresaCriteria copy() {
        return new OpcaoNomeFantasiaEmpresaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OpcaoNomeFantasiaEmpresaCriteria that = (OpcaoNomeFantasiaEmpresaCriteria) o;
        return (
    ...
    public String toString() {
        return "OpcaoNomeFantasiaEmpresaCriteria{" +
