...
public class PlanoContaAzulCriteria implements Serializable, Criteria {
    ...
    /**
     * Class for filtering SituacaoPlanoContaAzul
     */
    public static class SituacaoPlanoContaAzulFilter extends Filter<SituacaoPlanoContaAzul> {

        public SituacaoPlanoContaAzulFilter() {}

        public SituacaoPlanoContaAzulFilter(SituacaoPlanoContaAzulFilter filter) {
            super(filter);
        }

        @Override
        public SituacaoPlanoContaAzulFilter copy() {
            return new SituacaoPlanoContaAzulFilter(this);
        }
    }
    ...
    private SituacaoPlanoContaAzulFilter situacao;
    ...
    public PlanoContaAzulCriteria(PlanoContaAzulCriteria other) {
        ...
        this.situacao = other.optionalSituacao().map(SituacaoPlanoContaAzulFilter::copy).orElse(null);
    ...
    public SituacaoPlanoContaAzulFilter getSituacao() {
        return situacao;
    }

    public Optional<SituacaoPlanoContaAzulFilter> optionalSituacao() {
        return Optional.ofNullable(situacao);
    }

    public SituacaoPlanoContaAzulFilter situacao() {
        if (situacao == null) {
            setSituacao(new SituacaoPlanoContaAzulFilter());
        }
        return situacao;
    }

    public void setSituacao(SituacaoPlanoContaAzulFilter situacao) {
