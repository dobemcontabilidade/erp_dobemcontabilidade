...
public class AssinaturaEmpresaCriteria implements Serializable, Criteria {
    ...
    private SituacaoContratoEmpresaEnumFilter situacaoContratoEmpresa;

    private TipoContratoEnumFilter tipoContrato;

    private LongFilter grupoAcessoEmpresaId;

    private LongFilter areaContabilAssinaturaEmpresaId;

    private LongFilter servicoContabilAssinaturaEmpresaId;

    private LongFilter gatewayAssinaturaEmpresaId;

    private LongFilter calculoPlanoAssinaturaId;

    private LongFilter pagamentoId;

    private LongFilter cobrancaEmpresaId;
    ...
    public AssinaturaEmpresaCriteria(AssinaturaEmpresaCriteria other) {
        ...
        this.situacaoContratoEmpresa = other.optionalSituacaoContratoEmpresa().map(SituacaoContratoEmpresaEnumFilter::copy).orElse(null);
        this.tipoContrato = other.optionalTipoContrato().map(TipoContratoEnumFilter::copy).orElse(null);
        this.grupoAcessoEmpresaId = other.optionalGrupoAcessoEmpresaId().map(LongFilter::copy).orElse(null);
        this.areaContabilAssinaturaEmpresaId = other.optionalAreaContabilAssinaturaEmpresaId().map(LongFilter::copy).orElse(null);
        this.servicoContabilAssinaturaEmpresaId = other.optionalServicoContabilAssinaturaEmpresaId().map(LongFilter::copy).orElse(null);
        this.gatewayAssinaturaEmpresaId = other.optionalGatewayAssinaturaEmpresaId().map(LongFilter::copy).orElse(null);
        ...
        this.cobrancaEmpresaId = other.optionalCobrancaEmpresaId().map(LongFilter::copy).orElse(null);
    ...
    public SituacaoContratoEmpresaEnumFilter getSituacaoContratoEmpresa() {
        return situacaoContratoEmpresa;
    }

    public Optional<SituacaoContratoEmpresaEnumFilter> optionalSituacaoContratoEmpresa() {
        return Optional.ofNullable(situacaoContratoEmpresa);
    }

    public SituacaoContratoEmpresaEnumFilter situacaoContratoEmpresa() {
        if (situacaoContratoEmpresa == null) {
            setSituacaoContratoEmpresa(new SituacaoContratoEmpresaEnumFilter());
        }
        return situacaoContratoEmpresa;
    }

    public void setSituacaoContratoEmpresa(SituacaoContratoEmpresaEnumFilter situacaoContratoEmpresa) {
    ...
    public LongFilter getGrupoAcessoEmpresaId() {
        return grupoAcessoEmpresaId;
    }

    public Optional<LongFilter> optionalGrupoAcessoEmpresaId() {
        return Optional.ofNullable(grupoAcessoEmpresaId);
    }

    public LongFilter grupoAcessoEmpresaId() {
        if (grupoAcessoEmpresaId == null) {
            setGrupoAcessoEmpresaId(new LongFilter());
        }
        return grupoAcessoEmpresaId;
    }

    public void setGrupoAcessoEmpresaId(LongFilter grupoAcessoEmpresaId) {
        this.grupoAcessoEmpresaId = grupoAcessoEmpresaId;
    }
    ...
    public LongFilter getServicoContabilAssinaturaEmpresaId() {
        return servicoContabilAssinaturaEmpresaId;
    }

    public Optional<LongFilter> optionalServicoContabilAssinaturaEmpresaId() {
        return Optional.ofNullable(servicoContabilAssinaturaEmpresaId);
    }

    public LongFilter servicoContabilAssinaturaEmpresaId() {
        if (servicoContabilAssinaturaEmpresaId == null) {
            setServicoContabilAssinaturaEmpresaId(new LongFilter());
        }
        return servicoContabilAssinaturaEmpresaId;
    }

    public void setServicoContabilAssinaturaEmpresaId(LongFilter servicoContabilAssinaturaEmpresaId) {
        this.servicoContabilAssinaturaEmpresaId = servicoContabilAssinaturaEmpresaId;
    }

    public LongFilter getGatewayAssinaturaEmpresaId() {
        return gatewayAssinaturaEmpresaId;
    }

    public Optional<LongFilter> optionalGatewayAssinaturaEmpresaId() {
        return Optional.ofNullable(gatewayAssinaturaEmpresaId);
    }

    public LongFilter gatewayAssinaturaEmpresaId() {
        if (gatewayAssinaturaEmpresaId == null) {
            setGatewayAssinaturaEmpresaId(new LongFilter());
        }
        return gatewayAssinaturaEmpresaId;
    }

    public void setGatewayAssinaturaEmpresaId(LongFilter gatewayAssinaturaEmpresaId) {
        this.gatewayAssinaturaEmpresaId = gatewayAssinaturaEmpresaId;
    }
    ...
    public LongFilter getCobrancaEmpresaId() {
        return cobrancaEmpresaId;
    }

    public Optional<LongFilter> optionalCobrancaEmpresaId() {
        return Optional.ofNullable(cobrancaEmpresaId);
    }

    public LongFilter cobrancaEmpresaId() {
        if (cobrancaEmpresaId == null) {
            setCobrancaEmpresaId(new LongFilter());
        }
        return cobrancaEmpresaId;
    }

    public void setCobrancaEmpresaId(LongFilter cobrancaEmpresaId) {
        this.cobrancaEmpresaId = cobrancaEmpresaId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(situacaoContratoEmpresa, that.situacaoContratoEmpresa) &&
            Objects.equals(tipoContrato, that.tipoContrato) &&
            Objects.equals(grupoAcessoEmpresaId, that.grupoAcessoEmpresaId) &&
            Objects.equals(areaContabilAssinaturaEmpresaId, that.areaContabilAssinaturaEmpresaId) &&
            Objects.equals(servicoContabilAssinaturaEmpresaId, that.servicoContabilAssinaturaEmpresaId) &&
            Objects.equals(gatewayAssinaturaEmpresaId, that.gatewayAssinaturaEmpresaId) &&
            Objects.equals(calculoPlanoAssinaturaId, that.calculoPlanoAssinaturaId) &&
            Objects.equals(pagamentoId, that.pagamentoId) &&
            Objects.equals(cobrancaEmpresaId, that.cobrancaEmpresaId) &&
    ...
    public int hashCode() {
        return Objects.hash(
            ...
            dataEncerramento,
            diaVencimento,
            situacaoContratoEmpresa,
            tipoContrato,
            grupoAcessoEmpresaId,
            areaContabilAssinaturaEmpresaId,
            servicoContabilAssinaturaEmpresaId,
            gatewayAssinaturaEmpresaId,
    ...
    public String toString() {
        return "AssinaturaEmpresaCriteria{" +
            ...
            optionalSituacaoContratoEmpresa().map(f -> "situacaoContratoEmpresa=" + f + ", ").orElse("") +
            optionalTipoContrato().map(f -> "tipoContrato=" + f + ", ").orElse("") +
            optionalGrupoAcessoEmpresaId().map(f -> "grupoAcessoEmpresaId=" + f + ", ").orElse("") +
            optionalAreaContabilAssinaturaEmpresaId().map(f -> "areaContabilAssinaturaEmpresaId=" + f + ", ").orElse("") +
            optionalServicoContabilAssinaturaEmpresaId().map(f -> "servicoContabilAssinaturaEmpresaId=" + f + ", ").orElse("") +
            optionalGatewayAssinaturaEmpresaId().map(f -> "gatewayAssinaturaEmpresaId=" + f + ", ").orElse("") +
            optionalCalculoPlanoAssinaturaId().map(f -> "calculoPlanoAssinaturaId=" + f + ", ").orElse("") +
            optionalPagamentoId().map(f -> "pagamentoId=" + f + ", ").orElse("") +
            optionalCobrancaEmpresaId().map(f -> "cobrancaEmpresaId=" + f + ", ").orElse("") +
