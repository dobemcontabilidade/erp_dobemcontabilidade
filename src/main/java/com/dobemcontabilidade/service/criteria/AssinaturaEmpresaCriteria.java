...
public class AssinaturaEmpresaCriteria implements Serializable, Criteria {
    ...
    private LongFilter termoContratoAssinaturaEmpresaId;
    ...
    public AssinaturaEmpresaCriteria(AssinaturaEmpresaCriteria other) {
        ...
        this.termoContratoAssinaturaEmpresaId = other.optionalTermoContratoAssinaturaEmpresaId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getTermoContratoAssinaturaEmpresaId() {
        return termoContratoAssinaturaEmpresaId;
    }

    public Optional<LongFilter> optionalTermoContratoAssinaturaEmpresaId() {
        return Optional.ofNullable(termoContratoAssinaturaEmpresaId);
    }

    public LongFilter termoContratoAssinaturaEmpresaId() {
        if (termoContratoAssinaturaEmpresaId == null) {
            setTermoContratoAssinaturaEmpresaId(new LongFilter());
        }
        return termoContratoAssinaturaEmpresaId;
    }

    public void setTermoContratoAssinaturaEmpresaId(LongFilter termoContratoAssinaturaEmpresaId) {
        this.termoContratoAssinaturaEmpresaId = termoContratoAssinaturaEmpresaId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(termoContratoAssinaturaEmpresaId, that.termoContratoAssinaturaEmpresaId) &&
    ...
    public int hashCode() {
        return Objects.hash(
            ...
            situacao,
            tipoContrato,
            termoContratoAssinaturaEmpresaId,
            periodoPagamentoId,
            formaDePagamentoId,
            empresaId,
            distinct
    ...
    public String toString() {
        return "AssinaturaEmpresaCriteria{" +
            ...
            optionalTermoContratoAssinaturaEmpresaId().map(f -> "termoContratoAssinaturaEmpresaId=" + f + ", ").orElse("") +
