...
public class PerfilRedeSocialCriteria implements Serializable, Criteria {
    ...
    /**
     * Class for filtering TipoRedeSocialEnum
     */
    public static class TipoRedeSocialEnumFilter extends Filter<TipoRedeSocialEnum> {

        public TipoRedeSocialEnumFilter() {}

        public TipoRedeSocialEnumFilter(TipoRedeSocialEnumFilter filter) {
            super(filter);
        }

        @Override
        public TipoRedeSocialEnumFilter copy() {
            return new TipoRedeSocialEnumFilter(this);
        }
    }
    ...
    private TipoRedeSocialEnumFilter tipoRede;
    ...
    public PerfilRedeSocialCriteria(PerfilRedeSocialCriteria other) {
        ...
        this.tipoRede = other.optionalTipoRede().map(TipoRedeSocialEnumFilter::copy).orElse(null);
    ...
    public TipoRedeSocialEnumFilter getTipoRede() {
        return tipoRede;
    }

    public Optional<TipoRedeSocialEnumFilter> optionalTipoRede() {
        return Optional.ofNullable(tipoRede);
    }

    public TipoRedeSocialEnumFilter tipoRede() {
        if (tipoRede == null) {
            setTipoRede(new TipoRedeSocialEnumFilter());
        }
        return tipoRede;
    }

    public void setTipoRede(TipoRedeSocialEnumFilter tipoRede) {
