...
/**
 * Criteria class for the {@link com.dobemcontabilidade.domain.ValorBaseRamo} entity. This class is used
 * in {@link com.dobemcontabilidade.web.rest.ValorBaseRamoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /valor-base-ramos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ValorBaseRamoCriteria implements Serializable, Criteria {
    ...
    public ValorBaseRamoCriteria() {}

    public ValorBaseRamoCriteria(ValorBaseRamoCriteria other) {
    ...
    @Override
    public ValorBaseRamoCriteria copy() {
        return new ValorBaseRamoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ValorBaseRamoCriteria that = (ValorBaseRamoCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, valorBase, ramoId, planoContabilId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "ValorBaseRamoCriteria{" +
