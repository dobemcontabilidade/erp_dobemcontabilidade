...
public class EnderecoPessoaCriteria implements Serializable, Criteria {
    ...
    private BooleanFilter residenciaPropria;
    ...
    public EnderecoPessoaCriteria(EnderecoPessoaCriteria other) {
        ...
        this.residenciaPropria = other.optionalResidenciaPropria().map(BooleanFilter::copy).orElse(null);
    ...
    public BooleanFilter getResidenciaPropria() {
        return residenciaPropria;
    }

    public Optional<BooleanFilter> optionalResidenciaPropria() {
        return Optional.ofNullable(residenciaPropria);
    }

    public BooleanFilter residenciaPropria() {
        if (residenciaPropria == null) {
            setResidenciaPropria(new BooleanFilter());
        }
        return residenciaPropria;
    }

    public void setResidenciaPropria(BooleanFilter residenciaPropria) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(residenciaPropria, that.residenciaPropria) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, logradouro, numero, complemento, bairro, cep, principal, residenciaPropria, pessoaId, cidadeId, distinct);
    }
    ...
    public String toString() {
        return "EnderecoPessoaCriteria{" +
            ...
            optionalResidenciaPropria().map(f -> "residenciaPropria=" + f + ", ").orElse("") +
