...
public class FrequenciaCriteria implements Serializable, Criteria {
    ...
    private StringFilter prioridade;
    ...
    public FrequenciaCriteria(FrequenciaCriteria other) {
        ...
        this.prioridade = other.optionalPrioridade().map(StringFilter::copy).orElse(null);
    ...
    public StringFilter getPrioridade() {
        return prioridade;
    }

    public Optional<StringFilter> optionalPrioridade() {
        return Optional.ofNullable(prioridade);
    }

    public StringFilter prioridade() {
        if (prioridade == null) {
            setPrioridade(new StringFilter());
        }
        return prioridade;
    }

    public void setPrioridade(StringFilter prioridade) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nome, prioridade, numeroDias, tarefaId, distinct);
    }
