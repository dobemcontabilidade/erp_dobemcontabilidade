...
/**
 * Criteria class for the {@link com.dobemcontabilidade.domain.AnexoPessoa} entity. This class is used
 * in {@link com.dobemcontabilidade.web.rest.AnexoPessoaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /anexo-pessoas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AnexoPessoaCriteria implements Serializable, Criteria {
    ...
    public AnexoPessoaCriteria() {}

    public AnexoPessoaCriteria(AnexoPessoaCriteria other) {
    ...
    @Override
    public AnexoPessoaCriteria copy() {
        return new AnexoPessoaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AnexoPessoaCriteria that = (AnexoPessoaCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, tipo, pessoaId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "AnexoPessoaCriteria{" +
