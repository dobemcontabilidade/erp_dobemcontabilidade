...
public class UsuarioGestaoCriteria implements Serializable, Criteria {
    ...
    private SituacaoUsuarioGestaoEnumFilter situacaoUsuarioGestao;
    ...
    public UsuarioGestaoCriteria(UsuarioGestaoCriteria other) {
        ...
        this.situacaoUsuarioGestao = other.optionalSituacaoUsuarioGestao().map(SituacaoUsuarioGestaoEnumFilter::copy).orElse(null);
    ...
    public SituacaoUsuarioGestaoEnumFilter getSituacaoUsuarioGestao() {
        return situacaoUsuarioGestao;
    }

    public Optional<SituacaoUsuarioGestaoEnumFilter> optionalSituacaoUsuarioGestao() {
        return Optional.ofNullable(situacaoUsuarioGestao);
    }

    public SituacaoUsuarioGestaoEnumFilter situacaoUsuarioGestao() {
        if (situacaoUsuarioGestao == null) {
            setSituacaoUsuarioGestao(new SituacaoUsuarioGestaoEnumFilter());
        }
        return situacaoUsuarioGestao;
    }

    public void setSituacaoUsuarioGestao(SituacaoUsuarioGestaoEnumFilter situacaoUsuarioGestao) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(situacaoUsuarioGestao, that.situacaoUsuarioGestao) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, email, ativo, dataHoraAtivacao, dataLimiteAcesso, situacaoUsuarioGestao, administradorId, distinct);
    }
    ...
    public String toString() {
        return "UsuarioGestaoCriteria{" +
            ...
            optionalSituacaoUsuarioGestao().map(f -> "situacaoUsuarioGestao=" + f + ", ").orElse("") +
