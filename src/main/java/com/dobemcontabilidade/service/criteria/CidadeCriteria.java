...
public class CidadeCriteria implements Serializable, Criteria {
    ...
    private LongFilter agenteIntegracaoEstagioId;

    private LongFilter empresaModeloId;

    private LongFilter fluxoModeloId;
    ...
    public CidadeCriteria(CidadeCriteria other) {
        ...
        this.instituicaoEnsinoId = other.optionalInstituicaoEnsinoId().map(LongFilter::copy).orElse(null);
        this.agenteIntegracaoEstagioId = other.optionalAgenteIntegracaoEstagioId().map(LongFilter::copy).orElse(null);
        this.empresaModeloId = other.optionalEmpresaModeloId().map(LongFilter::copy).orElse(null);
        this.fluxoModeloId = other.optionalFluxoModeloId().map(LongFilter::copy).orElse(null);
    ...
    public Optional<LongFilter> optionalInstituicaoEnsinoId() {
        return Optional.ofNullable(instituicaoEnsinoId);
    }

    public LongFilter instituicaoEnsinoId() {
        if (instituicaoEnsinoId == null) {
            setInstituicaoEnsinoId(new LongFilter());
        }
        return instituicaoEnsinoId;
    }
    ...
    public LongFilter getAgenteIntegracaoEstagioId() {
        return agenteIntegracaoEstagioId;
    }

    public Optional<LongFilter> optionalAgenteIntegracaoEstagioId() {
        return Optional.ofNullable(agenteIntegracaoEstagioId);
    }

    public LongFilter agenteIntegracaoEstagioId() {
        if (agenteIntegracaoEstagioId == null) {
            setAgenteIntegracaoEstagioId(new LongFilter());
        }
        return agenteIntegracaoEstagioId;
    }

    public void setAgenteIntegracaoEstagioId(LongFilter agenteIntegracaoEstagioId) {
        this.agenteIntegracaoEstagioId = agenteIntegracaoEstagioId;
    }
    ...
    public LongFilter getFluxoModeloId() {
        return fluxoModeloId;
    }

    public Optional<LongFilter> optionalFluxoModeloId() {
        return Optional.ofNullable(fluxoModeloId);
    }

    public LongFilter fluxoModeloId() {
        if (fluxoModeloId == null) {
            setFluxoModeloId(new LongFilter());
        }
        return fluxoModeloId;
    }

    public void setFluxoModeloId(LongFilter fluxoModeloId) {
        this.fluxoModeloId = fluxoModeloId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(agenteIntegracaoEstagioId, that.agenteIntegracaoEstagioId) &&
            Objects.equals(empresaModeloId, that.empresaModeloId) &&
            Objects.equals(fluxoModeloId, that.fluxoModeloId) &&
    ...
    public String toString() {
        return "CidadeCriteria{" +
            ...
            optionalInstituicaoEnsinoId().map(f -> "instituicaoEnsinoId=" + f + ", ").orElse("") +
            optionalAgenteIntegracaoEstagioId().map(f -> "agenteIntegracaoEstagioId=" + f + ", ").orElse("") +
            optionalEmpresaModeloId().map(f -> "empresaModeloId=" + f + ", ").orElse("") +
            optionalFluxoModeloId().map(f -> "fluxoModeloId=" + f + ", ").orElse("") +
