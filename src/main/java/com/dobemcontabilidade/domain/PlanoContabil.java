...
public class PlanoContabil implements Serializable {
    ...
    public void setTermoAdesaoEmpresas(Set<TermoAdesaoEmpresa> termoAdesaoEmpresas) {
        if (this.termoAdesaoEmpresas != null) {
            this.termoAdesaoEmpresas.forEach(i -> i.setPlanoContabil(null));
        }
        if (termoAdesaoEmpresas != null) {
            termoAdesaoEmpresas.forEach(i -> i.setPlanoContabil(this));
        }
        this.termoAdesaoEmpresas = termoAdesaoEmpresas;
    }

    public PlanoContabil termoAdesaoEmpresas(Set<TermoAdesaoEmpresa> termoAdesaoEmpresas) {
        this.setTermoAdesaoEmpresas(termoAdesaoEmpresas);
        return this;
    }

    public PlanoContabil addTermoAdesaoEmpresa(TermoAdesaoEmpresa termoAdesaoEmpresa) {
        this.termoAdesaoEmpresas.add(termoAdesaoEmpresa);
        termoAdesaoEmpresa.setPlanoContabil(this);
        return this;
    }

    public PlanoContabil removeTermoAdesaoEmpresa(TermoAdesaoEmpresa termoAdesaoEmpresa) {
        this.termoAdesaoEmpresas.remove(termoAdesaoEmpresa);
        termoAdesaoEmpresa.setPlanoContabil(null);
        return this;
    }
