...
public class FormaDePagamento implements Serializable {
    ...
    public void setCobrancaEmpresas(Set<CobrancaEmpresa> cobrancaEmpresas) {
        if (this.cobrancaEmpresas != null) {
            this.cobrancaEmpresas.forEach(i -> i.setFormaDePagamento(null));
        }
        if (cobrancaEmpresas != null) {
            cobrancaEmpresas.forEach(i -> i.setFormaDePagamento(this));
        }
        this.cobrancaEmpresas = cobrancaEmpresas;
    }

    public FormaDePagamento cobrancaEmpresas(Set<CobrancaEmpresa> cobrancaEmpresas) {
        this.setCobrancaEmpresas(cobrancaEmpresas);
        return this;
    }

    public FormaDePagamento addCobrancaEmpresa(CobrancaEmpresa cobrancaEmpresa) {
        this.cobrancaEmpresas.add(cobrancaEmpresa);
        cobrancaEmpresa.setFormaDePagamento(this);
        return this;
    }

    public FormaDePagamento removeCobrancaEmpresa(CobrancaEmpresa cobrancaEmpresa) {
        this.cobrancaEmpresas.remove(cobrancaEmpresa);
        cobrancaEmpresa.setFormaDePagamento(null);
        return this;
    }
