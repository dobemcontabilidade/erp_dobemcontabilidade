...
public class AssinaturaEmpresa implements Serializable {
    ...
    @Column(name = "situacao_contrato_empresa")
    private SituacaoContratoEmpresaEnum situacaoContratoEmpresa;
    ...
    private Set<GrupoAcessoEmpresa> grupoAcessoEmpresas = new HashSet<>();
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "assinaturaEmpresa")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "assinaturaEmpresa", "formaDePagamento" }, allowSetters = true)
    private Set<CobrancaEmpresa> cobrancaEmpresas = new HashSet<>();
    ...
    public SituacaoContratoEmpresaEnum getSituacaoContratoEmpresa() {
        return this.situacaoContratoEmpresa;
    }

    public AssinaturaEmpresa situacaoContratoEmpresa(SituacaoContratoEmpresaEnum situacaoContratoEmpresa) {
        this.setSituacaoContratoEmpresa(situacaoContratoEmpresa);
        return this;
    }

    public void setSituacaoContratoEmpresa(SituacaoContratoEmpresaEnum situacaoContratoEmpresa) {
        this.situacaoContratoEmpresa = situacaoContratoEmpresa;
    }
    ...
    public Set<GrupoAcessoEmpresa> getGrupoAcessoEmpresas() {
        return this.grupoAcessoEmpresas;
    }

    public void setGrupoAcessoEmpresas(Set<GrupoAcessoEmpresa> grupoAcessoEmpresas) {
        if (this.grupoAcessoEmpresas != null) {
            this.grupoAcessoEmpresas.forEach(i -> i.setAssinaturaEmpresa(null));
        }
        if (grupoAcessoEmpresas != null) {
            grupoAcessoEmpresas.forEach(i -> i.setAssinaturaEmpresa(this));
        }
        this.grupoAcessoEmpresas = grupoAcessoEmpresas;
    }

    public AssinaturaEmpresa grupoAcessoEmpresas(Set<GrupoAcessoEmpresa> grupoAcessoEmpresas) {
        this.setGrupoAcessoEmpresas(grupoAcessoEmpresas);
        return this;
    }

    public AssinaturaEmpresa addGrupoAcessoEmpresa(GrupoAcessoEmpresa grupoAcessoEmpresa) {
        this.grupoAcessoEmpresas.add(grupoAcessoEmpresa);
        grupoAcessoEmpresa.setAssinaturaEmpresa(this);
        return this;
    }

    public AssinaturaEmpresa removeGrupoAcessoEmpresa(GrupoAcessoEmpresa grupoAcessoEmpresa) {
        this.grupoAcessoEmpresas.remove(grupoAcessoEmpresa);
        grupoAcessoEmpresa.setAssinaturaEmpresa(null);
        return this;
    }
    ...
    public void setAreaContabilAssinaturaEmpresas(Set<AreaContabilAssinaturaEmpresa> areaContabilAssinaturaEmpresas) {
        if (this.areaContabilAssinaturaEmpresas != null) {
            this.areaContabilAssinaturaEmpresas.forEach(i -> i.setAssinaturaEmpresa(null));
        }
        if (areaContabilAssinaturaEmpresas != null) {
            areaContabilAssinaturaEmpresas.forEach(i -> i.setAssinaturaEmpresa(this));
        }
        this.areaContabilAssinaturaEmpresas = areaContabilAssinaturaEmpresas;
    }

    public AssinaturaEmpresa areaContabilAssinaturaEmpresas(Set<AreaContabilAssinaturaEmpresa> areaContabilAssinaturaEmpresas) {
        this.setAreaContabilAssinaturaEmpresas(areaContabilAssinaturaEmpresas);
        return this;
    }

    public AssinaturaEmpresa addAreaContabilAssinaturaEmpresa(AreaContabilAssinaturaEmpresa areaContabilAssinaturaEmpresa) {
        this.areaContabilAssinaturaEmpresas.add(areaContabilAssinaturaEmpresa);
        areaContabilAssinaturaEmpresa.setAssinaturaEmpresa(this);
        return this;
    }

    public AssinaturaEmpresa removeAreaContabilAssinaturaEmpresa(AreaContabilAssinaturaEmpresa areaContabilAssinaturaEmpresa) {
        this.areaContabilAssinaturaEmpresas.remove(areaContabilAssinaturaEmpresa);
        areaContabilAssinaturaEmpresa.setAssinaturaEmpresa(null);
        return this;
    }
    ...
    public void setServicoContabilAssinaturaEmpresas(Set<ServicoContabilAssinaturaEmpresa> servicoContabilAssinaturaEmpresas) {
        if (this.servicoContabilAssinaturaEmpresas != null) {
            this.servicoContabilAssinaturaEmpresas.forEach(i -> i.setAssinaturaEmpresa(null));
        }
        if (servicoContabilAssinaturaEmpresas != null) {
            servicoContabilAssinaturaEmpresas.forEach(i -> i.setAssinaturaEmpresa(this));
        }
        this.servicoContabilAssinaturaEmpresas = servicoContabilAssinaturaEmpresas;
    }

    public AssinaturaEmpresa servicoContabilAssinaturaEmpresas(Set<ServicoContabilAssinaturaEmpresa> servicoContabilAssinaturaEmpresas) {
        this.setServicoContabilAssinaturaEmpresas(servicoContabilAssinaturaEmpresas);
        return this;
    }

    public AssinaturaEmpresa addServicoContabilAssinaturaEmpresa(ServicoContabilAssinaturaEmpresa servicoContabilAssinaturaEmpresa) {
        this.servicoContabilAssinaturaEmpresas.add(servicoContabilAssinaturaEmpresa);
        servicoContabilAssinaturaEmpresa.setAssinaturaEmpresa(this);
        return this;
    }

    public AssinaturaEmpresa removeServicoContabilAssinaturaEmpresa(ServicoContabilAssinaturaEmpresa servicoContabilAssinaturaEmpresa) {
        this.servicoContabilAssinaturaEmpresas.remove(servicoContabilAssinaturaEmpresa);
        servicoContabilAssinaturaEmpresa.setAssinaturaEmpresa(null);
        return this;
    }
    ...
    public void setGatewayAssinaturaEmpresas(Set<GatewayAssinaturaEmpresa> gatewayAssinaturaEmpresas) {
        if (this.gatewayAssinaturaEmpresas != null) {
            this.gatewayAssinaturaEmpresas.forEach(i -> i.setAssinaturaEmpresa(null));
        }
        if (gatewayAssinaturaEmpresas != null) {
            gatewayAssinaturaEmpresas.forEach(i -> i.setAssinaturaEmpresa(this));
        }
        this.gatewayAssinaturaEmpresas = gatewayAssinaturaEmpresas;
    }

    public AssinaturaEmpresa gatewayAssinaturaEmpresas(Set<GatewayAssinaturaEmpresa> gatewayAssinaturaEmpresas) {
        this.setGatewayAssinaturaEmpresas(gatewayAssinaturaEmpresas);
        return this;
    }

    public AssinaturaEmpresa addGatewayAssinaturaEmpresa(GatewayAssinaturaEmpresa gatewayAssinaturaEmpresa) {
        this.gatewayAssinaturaEmpresas.add(gatewayAssinaturaEmpresa);
        gatewayAssinaturaEmpresa.setAssinaturaEmpresa(this);
        return this;
    }

    public AssinaturaEmpresa removeGatewayAssinaturaEmpresa(GatewayAssinaturaEmpresa gatewayAssinaturaEmpresa) {
        this.gatewayAssinaturaEmpresas.remove(gatewayAssinaturaEmpresa);
        gatewayAssinaturaEmpresa.setAssinaturaEmpresa(null);
        return this;
    }
    ...
    public Set<CobrancaEmpresa> getCobrancaEmpresas() {
        return this.cobrancaEmpresas;
    }

    public void setCobrancaEmpresas(Set<CobrancaEmpresa> cobrancaEmpresas) {
        if (this.cobrancaEmpresas != null) {
            this.cobrancaEmpresas.forEach(i -> i.setAssinaturaEmpresa(null));
        }
        if (cobrancaEmpresas != null) {
            cobrancaEmpresas.forEach(i -> i.setAssinaturaEmpresa(this));
        }
        this.cobrancaEmpresas = cobrancaEmpresas;
    }

    public AssinaturaEmpresa cobrancaEmpresas(Set<CobrancaEmpresa> cobrancaEmpresas) {
        this.setCobrancaEmpresas(cobrancaEmpresas);
        return this;
    }

    public AssinaturaEmpresa addCobrancaEmpresa(CobrancaEmpresa cobrancaEmpresa) {
        this.cobrancaEmpresas.add(cobrancaEmpresa);
        cobrancaEmpresa.setAssinaturaEmpresa(this);
        return this;
    }

    public AssinaturaEmpresa removeCobrancaEmpresa(CobrancaEmpresa cobrancaEmpresa) {
        this.cobrancaEmpresas.remove(cobrancaEmpresa);
        cobrancaEmpresa.setAssinaturaEmpresa(null);
        return this;
    }
    ...
    public void setUsuarioEmpresas(Set<UsuarioEmpresa> usuarioEmpresas) {
        if (this.usuarioEmpresas != null) {
            this.usuarioEmpresas.forEach(i -> i.setAssinaturaEmpresa(null));
        }
        if (usuarioEmpresas != null) {
            usuarioEmpresas.forEach(i -> i.setAssinaturaEmpresa(this));
        }
        this.usuarioEmpresas = usuarioEmpresas;
    }

    public AssinaturaEmpresa usuarioEmpresas(Set<UsuarioEmpresa> usuarioEmpresas) {
        this.setUsuarioEmpresas(usuarioEmpresas);
        return this;
    }

    public AssinaturaEmpresa addUsuarioEmpresa(UsuarioEmpresa usuarioEmpresa) {
        this.usuarioEmpresas.add(usuarioEmpresa);
        usuarioEmpresa.setAssinaturaEmpresa(this);
        return this;
    }

    public AssinaturaEmpresa removeUsuarioEmpresa(UsuarioEmpresa usuarioEmpresa) {
        this.usuarioEmpresas.remove(usuarioEmpresa);
        usuarioEmpresa.setAssinaturaEmpresa(null);
        return this;
    }
    ...
    public String toString() {
        return "AssinaturaEmpresa{" +
            ...
            ", situacaoContratoEmpresa='" + getSituacaoContratoEmpresa() + "'" +
