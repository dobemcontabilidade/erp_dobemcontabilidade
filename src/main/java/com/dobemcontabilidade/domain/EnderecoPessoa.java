...
public class EnderecoPessoa implements Serializable {
    ...
    @Column(name = "residencia_propria")
    ...
    public EnderecoPessoa residenciaPropria(Boolean residenciaPropria) {
        this.setResidenciaPropria(residenciaPropria);
        return this;
    }
    ...
    public String toString() {
        return "EnderecoPessoa{" +
            ...
            ", residenciaPropria='" + getResidenciaPropria() + "'" +
            "}";
    }
}
