...
public class Ramo implements Serializable {
    ...
    public void setAnexoRequeridoEmpresas(Set<AnexoRequeridoEmpresa> anexoRequeridoEmpresas) {
        if (this.anexoRequeridoEmpresas != null) {
            this.anexoRequeridoEmpresas.forEach(i -> i.setRamo(null));
        }
        if (anexoRequeridoEmpresas != null) {
            anexoRequeridoEmpresas.forEach(i -> i.setRamo(this));
        }
        this.anexoRequeridoEmpresas = anexoRequeridoEmpresas;
    }

    public Ramo anexoRequeridoEmpresas(Set<AnexoRequeridoEmpresa> anexoRequeridoEmpresas) {
        this.setAnexoRequeridoEmpresas(anexoRequeridoEmpresas);
        return this;
    }

    public Ramo addAnexoRequeridoEmpresa(AnexoRequeridoEmpresa anexoRequeridoEmpresa) {
        this.anexoRequeridoEmpresas.add(anexoRequeridoEmpresa);
        anexoRequeridoEmpresa.setRamo(this);
        return this;
    }

    public Ramo removeAnexoRequeridoEmpresa(AnexoRequeridoEmpresa anexoRequeridoEmpresa) {
        this.anexoRequeridoEmpresas.remove(anexoRequeridoEmpresa);
        anexoRequeridoEmpresa.setRamo(null);
        return this;
    }
    ...
    public void setEmpresaModelos(Set<EmpresaModelo> empresaModelos) {
        if (this.empresaModelos != null) {
            this.empresaModelos.forEach(i -> i.setRamo(null));
        }
        if (empresaModelos != null) {
            empresaModelos.forEach(i -> i.setRamo(this));
        }
        this.empresaModelos = empresaModelos;
    }

    public Ramo empresaModelos(Set<EmpresaModelo> empresaModelos) {
        this.setEmpresaModelos(empresaModelos);
        return this;
    }

    public Ramo addEmpresaModelo(EmpresaModelo empresaModelo) {
        this.empresaModelos.add(empresaModelo);
        empresaModelo.setRamo(this);
        return this;
    }

    public Ramo removeEmpresaModelo(EmpresaModelo empresaModelo) {
        this.empresaModelos.remove(empresaModelo);
        empresaModelo.setRamo(null);
        return this;
    }
