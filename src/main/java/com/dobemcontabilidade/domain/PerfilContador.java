...
public class PerfilContador implements Serializable {
    ...
    public PerfilContador limiteAreaContabils(Integer limiteAreaContabils) {
    ...
    public void setPerfilContadorAreaContabils(Set<PerfilContadorAreaContabil> perfilContadorAreaContabils) {
        if (this.perfilContadorAreaContabils != null) {
            this.perfilContadorAreaContabils.forEach(i -> i.setPerfilContador(null));
        }
        if (perfilContadorAreaContabils != null) {
            perfilContadorAreaContabils.forEach(i -> i.setPerfilContador(this));
        }
        this.perfilContadorAreaContabils = perfilContadorAreaContabils;
    }

    public PerfilContador perfilContadorAreaContabils(Set<PerfilContadorAreaContabil> perfilContadorAreaContabils) {
        this.setPerfilContadorAreaContabils(perfilContadorAreaContabils);
        return this;
    }

    public PerfilContador addPerfilContadorAreaContabil(PerfilContadorAreaContabil perfilContadorAreaContabil) {
        this.perfilContadorAreaContabils.add(perfilContadorAreaContabil);
        perfilContadorAreaContabil.setPerfilContador(this);
        return this;
    }

    public PerfilContador removePerfilContadorAreaContabil(PerfilContadorAreaContabil perfilContadorAreaContabil) {
        this.perfilContadorAreaContabils.remove(perfilContadorAreaContabil);
        perfilContadorAreaContabil.setPerfilContador(null);
        return this;
    }
