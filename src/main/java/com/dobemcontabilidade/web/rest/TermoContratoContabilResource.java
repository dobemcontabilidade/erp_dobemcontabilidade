...
public class TermoContratoContabilResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<TermoContratoContabil> createTermoContratoContabil(
        @Valid @RequestBody TermoContratoContabil termoContratoContabil
        ...
        termoContratoContabil = termoContratoContabilService.save(termoContratoContabil);
    ...
    public ResponseEntity<TermoContratoContabil> updateTermoContratoContabil(
        ...
        termoContratoContabil = termoContratoContabilService.update(termoContratoContabil);
    ...
    public ResponseEntity<TermoContratoContabil> partialUpdateTermoContratoContabil(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody TermoContratoContabil termoContratoContabil
    ) throws URISyntaxException {
        ...
        Optional<TermoContratoContabil> result = termoContratoContabilService.partialUpdate(termoContratoContabil);
    ...
    public List<TermoContratoContabil> getAllTermoContratoContabils(
        ...
        return termoContratoContabilService.findAll();
    }
    ...
    public ResponseEntity<TermoContratoContabil> getTermoContratoContabil(@PathVariable("id") Long id) {
        ...
        Optional<TermoContratoContabil> termoContratoContabil = termoContratoContabilService.findOne(id);
