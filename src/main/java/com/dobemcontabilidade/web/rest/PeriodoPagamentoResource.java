...
public class PeriodoPagamentoResource {
    ...
    public ResponseEntity<PeriodoPagamento> createPeriodoPagamento(@RequestBody PeriodoPagamento periodoPagamento)
        ...
        periodoPagamento = periodoPagamentoService.save(periodoPagamento);
    ...
    public ResponseEntity<PeriodoPagamento> updatePeriodoPagamento(
        ...
        periodoPagamento = periodoPagamentoService.update(periodoPagamento);
    ...
    public ResponseEntity<PeriodoPagamento> partialUpdatePeriodoPagamento(
        ...
        Optional<PeriodoPagamento> result = periodoPagamentoService.partialUpdate(periodoPagamento);
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<PeriodoPagamento>> getAllPeriodoPagamentos(
        PeriodoPagamentoCriteria criteria,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get PeriodoPagamentos by criteria: {}", criteria);

        Page<PeriodoPagamento> page = periodoPagamentoQueryService.findByCriteria(criteria, pageable);
    ...
    public ResponseEntity<PeriodoPagamento> getPeriodoPagamento(@PathVariable("id") Long id) {
        ...
        Optional<PeriodoPagamento> periodoPagamento = periodoPagamentoService.findOne(id);
