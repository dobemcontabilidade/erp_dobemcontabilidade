...
public class EnderecoPessoaResource {
    ...
    public ResponseEntity<EnderecoPessoa> createEnderecoPessoa(@Valid @RequestBody EnderecoPessoa enderecoPessoa)
        ...
        enderecoPessoa = enderecoPessoaService.save(enderecoPessoa);
    ...
    public ResponseEntity<EnderecoPessoa> updateEnderecoPessoa(
        ...
        enderecoPessoa = enderecoPessoaService.update(enderecoPessoa);
    ...
    public ResponseEntity<EnderecoPessoa> partialUpdateEnderecoPessoa(
        ...
        Optional<EnderecoPessoa> result = enderecoPessoaService.partialUpdate(enderecoPessoa);
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<EnderecoPessoa>> getAllEnderecoPessoas(
        EnderecoPessoaCriteria criteria,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get EnderecoPessoas by criteria: {}", criteria);

        Page<EnderecoPessoa> page = enderecoPessoaQueryService.findByCriteria(criteria, pageable);
    ...
    public ResponseEntity<EnderecoPessoa> getEnderecoPessoa(@PathVariable("id") Long id) {
        ...
        Optional<EnderecoPessoa> enderecoPessoa = enderecoPessoaService.findOne(id);
