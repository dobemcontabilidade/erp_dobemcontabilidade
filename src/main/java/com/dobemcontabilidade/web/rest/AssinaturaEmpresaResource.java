...
public class AssinaturaEmpresaResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<AssinaturaEmpresa>> getAllAssinaturaEmpresas(
        AssinaturaEmpresaCriteria criteria,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get AssinaturaEmpresas by criteria: {}", criteria);

        Page<AssinaturaEmpresa> page = assinaturaEmpresaQueryService.findByCriteria(criteria, pageable);
