...
public interface AreaContabilContadorRepository extends JpaRepository<AreaContabilContador, Long> {
    ...
    @Query(
        value = "select areaContabilContador from AreaContabilContador areaContabilContador left join fetch areaContabilContador.areaContabil left join fetch areaContabilContador.contador",
    ...
    @Query(
        "select areaContabilContador from AreaContabilContador areaContabilContador left join fetch areaContabilContador.areaContabil left join fetch areaContabilContador.contador"
    )
    List<AreaContabilContador> findAllWithToOneRelationships();

    @Query(
        "select areaContabilContador from AreaContabilContador areaContabilContador left join fetch areaContabilContador.areaContabil left join fetch areaContabilContador.contador where areaContabilContador.id =:id"
    )
