...
public interface DepartamentoFuncionarioRepository
    ...
    @Query(
        value = "select departamentoFuncionario from DepartamentoFuncionario departamentoFuncionario left join fetch departamentoFuncionario.funcionario left join fetch departamentoFuncionario.departamento",
    ...
    @Query(
        "select departamentoFuncionario from DepartamentoFuncionario departamentoFuncionario left join fetch departamentoFuncionario.funcionario left join fetch departamentoFuncionario.departamento"
    )
    List<DepartamentoFuncionario> findAllWithToOneRelationships();

    @Query(
        "select departamentoFuncionario from DepartamentoFuncionario departamentoFuncionario left join fetch departamentoFuncionario.funcionario left join fetch departamentoFuncionario.departamento where departamentoFuncionario.id =:id"
    )
