...
public interface AdicionalTributacaoRepository
    ...
    @Query(
        value = "select adicionalTributacao from AdicionalTributacao adicionalTributacao left join fetch adicionalTributacao.tributacao left join fetch adicionalTributacao.planoContabil",
    ...
    @Query(
        "select adicionalTributacao from AdicionalTributacao adicionalTributacao left join fetch adicionalTributacao.tributacao left join fetch adicionalTributacao.planoContabil"
    )
    List<AdicionalTributacao> findAllWithToOneRelationships();

    @Query(
        "select adicionalTributacao from AdicionalTributacao adicionalTributacao left join fetch adicionalTributacao.tributacao left join fetch adicionalTributacao.planoContabil where adicionalTributacao.id =:id"
    )
