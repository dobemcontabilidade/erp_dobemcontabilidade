...
public interface EnderecoEmpresaRepository extends JpaRepository<EnderecoEmpresa, Long> {
    ...
    @Query(
        value = "select enderecoEmpresa from EnderecoEmpresa enderecoEmpresa left join fetch enderecoEmpresa.cidade left join fetch enderecoEmpresa.pessoaJuridica",
    ...
    @Query(
        "select enderecoEmpresa from EnderecoEmpresa enderecoEmpresa left join fetch enderecoEmpresa.cidade left join fetch enderecoEmpresa.pessoaJuridica"
    )
    List<EnderecoEmpresa> findAllWithToOneRelationships();

    @Query(
        "select enderecoEmpresa from EnderecoEmpresa enderecoEmpresa left join fetch enderecoEmpresa.cidade left join fetch enderecoEmpresa.pessoaJuridica where enderecoEmpresa.id =:id"
    )
