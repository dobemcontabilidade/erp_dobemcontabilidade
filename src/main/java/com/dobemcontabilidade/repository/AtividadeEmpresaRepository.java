...
public interface AtividadeEmpresaRepository extends JpaRepository<AtividadeEmpresa, Long> {
    ...
    @Query(
        value = "select atividadeEmpresa from AtividadeEmpresa atividadeEmpresa left join fetch atividadeEmpresa.cnae left join fetch atividadeEmpresa.empresa",
    ...
    @Query(
        "select atividadeEmpresa from AtividadeEmpresa atividadeEmpresa left join fetch atividadeEmpresa.cnae left join fetch atividadeEmpresa.empresa"
    )
    List<AtividadeEmpresa> findAllWithToOneRelationships();

    @Query(
        "select atividadeEmpresa from AtividadeEmpresa atividadeEmpresa left join fetch atividadeEmpresa.cnae left join fetch atividadeEmpresa.empresa where atividadeEmpresa.id =:id"
    )
