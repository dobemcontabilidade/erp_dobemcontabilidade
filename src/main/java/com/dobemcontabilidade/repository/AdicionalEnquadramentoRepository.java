...
public interface AdicionalEnquadramentoRepository
    ...
    @Query(
        value = "select adicionalEnquadramento from AdicionalEnquadramento adicionalEnquadramento left join fetch adicionalEnquadramento.enquadramento left join fetch adicionalEnquadramento.planoAssinaturaContabil",
    ...
    @Query(
        "select adicionalEnquadramento from AdicionalEnquadramento adicionalEnquadramento left join fetch adicionalEnquadramento.enquadramento left join fetch adicionalEnquadramento.planoAssinaturaContabil"
    )
    List<AdicionalEnquadramento> findAllWithToOneRelationships();

    @Query(
        "select adicionalEnquadramento from AdicionalEnquadramento adicionalEnquadramento left join fetch adicionalEnquadramento.enquadramento left join fetch adicionalEnquadramento.planoAssinaturaContabil where adicionalEnquadramento.id =:id"
    )
