...
public interface AdministradorRepository extends JpaRepository<Administrador, Long> {
    ...
    @Query(
        value = "select administrador from Administrador administrador left join fetch administrador.pessoa",
    ...
    @Query("select administrador from Administrador administrador left join fetch administrador.pessoa")
    List<Administrador> findAllWithToOneRelationships();

    @Query("select administrador from Administrador administrador left join fetch administrador.pessoa where administrador.id =:id")
