...
class RamoResourceIT {
    ...
    void createRamo() throws Exception {
        ...
        var returnedRamo = om.readValue(
            restRamoMockMvc
                .perform(post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(ramo)))
    ...
    void putNonExistingRamo() throws Exception {
        ...
        restRamoMockMvc
            .perform(
                put(ENTITY_API_URL_ID, ramo.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void putWithMissingIdPathParamRamo() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restRamoMockMvc
            .perform(put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(ramo)))
    ...
    void partialUpdateRamoWithPatch() throws Exception {
        ...
        partialUpdatedRamo.descricao(UPDATED_DESCRICAO);
    ...
    void patchNonExistingRamo() throws Exception {
        ...
        restRamoMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, ramo.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(ramo))
            )
    ...
    void patchWithMissingIdPathParamRamo() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restRamoMockMvc
            .perform(patch(ENTITY_API_URL).with(csrf()).contentType("application/merge-patch+json").content(om.writeValueAsBytes(ramo)))
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteRamo() throws Exception {
        ...
        // Delete the ramo
        restRamoMockMvc
            .perform(delete(ENTITY_API_URL_ID, ramo.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
