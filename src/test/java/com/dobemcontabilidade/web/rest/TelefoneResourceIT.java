...
class TelefoneResourceIT {
    ...
    private static final String DEFAULT_CODIGO_AREA = "AAA";
    private static final String UPDATED_CODIGO_AREA = "BBB";
    ...
    @Test
    @Transactional
    void getAllTelefonesByPrincipalIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedTelefone = telefoneRepository.saveAndFlush(telefone);

        // Get all the telefoneList where principal equals to
        defaultTelefoneFiltering("principal.equals=" + DEFAULT_PRINCIPAL, "principal.equals=" + UPDATED_PRINCIPAL);
    }

    @Test
    @Transactional
    void getAllTelefonesByPrincipalIsInShouldWork() throws Exception {
        // Initialize the database
        insertedTelefone = telefoneRepository.saveAndFlush(telefone);

        // Get all the telefoneList where principal in
        defaultTelefoneFiltering("principal.in=" + DEFAULT_PRINCIPAL + "," + UPDATED_PRINCIPAL, "principal.in=" + UPDATED_PRINCIPAL);
    }

    @Test
    @Transactional
    void getAllTelefonesByPrincipalIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedTelefone = telefoneRepository.saveAndFlush(telefone);

        // Get all the telefoneList where principal is not null
        defaultTelefoneFiltering("principal.specified=true", "principal.specified=false");
    }
    ...
    void partialUpdateTelefoneWithPatch() throws Exception {
        ...
        partialUpdatedTelefone.codigoArea(UPDATED_CODIGO_AREA).principal(UPDATED_PRINCIPAL);
