...
class CertificadoDigitalResourceIT {
    ...
    void createCertificadoDigital() throws Exception {
        ...
        CertificadoDigitalDTO certificadoDigitalDTO = certificadoDigitalMapper.toDto(certificadoDigital);
        var returnedCertificadoDigitalDTO = om.readValue(
            restCertificadoDigitalMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(certificadoDigitalDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            CertificadoDigitalDTO.class
        );

        // Validate the CertificadoDigital in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedCertificadoDigital = certificadoDigitalMapper.toEntity(returnedCertificadoDigitalDTO);
    ...
    void putExistingCertificadoDigital() throws Exception {
        ...
        updatedCertificadoDigital
            ...
            .validade(UPDATED_VALIDADE)
            .tipoCertificado(UPDATED_TIPO_CERTIFICADO);
        CertificadoDigitalDTO certificadoDigitalDTO = certificadoDigitalMapper.toDto(updatedCertificadoDigital);

        restCertificadoDigitalMockMvc
            .perform(
                put(ENTITY_API_URL_ID, certificadoDigitalDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(certificadoDigitalDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamCertificadoDigital() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCertificadoDigitalMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(certificadoDigitalDTO)))
    ...
    void partialUpdateCertificadoDigitalWithPatch() throws Exception {
        ...
        partialUpdatedCertificadoDigital.dataContratacao(UPDATED_DATA_CONTRATACAO).tipoCertificado(UPDATED_TIPO_CERTIFICADO);
    ...
    void patchNonExistingCertificadoDigital() throws Exception {
        ...
        restCertificadoDigitalMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, certificadoDigitalDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(certificadoDigitalDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamCertificadoDigital() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCertificadoDigitalMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(certificadoDigitalDTO)))
            .andExpect(status().isMethodNotAllowed());
