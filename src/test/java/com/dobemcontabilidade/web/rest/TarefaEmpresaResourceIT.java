...
class TarefaEmpresaResourceIT {
    ...
    void createTarefaEmpresa() throws Exception {
        ...
        var returnedTarefaEmpresa = om.readValue(
            restTarefaEmpresaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(tarefaEmpresa)))
    ...
    void putExistingTarefaEmpresa() throws Exception {
        ...
        restTarefaEmpresaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedTarefaEmpresa.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedTarefaEmpresa))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingTarefaEmpresa() throws Exception {
        ...
        restTarefaEmpresaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, tarefaEmpresa.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(tarefaEmpresa))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamTarefaEmpresa() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTarefaEmpresaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(tarefaEmpresa)))
    ...
    void patchNonExistingTarefaEmpresa() throws Exception {
        ...
        restTarefaEmpresaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, tarefaEmpresa.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(tarefaEmpresa))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamTarefaEmpresa() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTarefaEmpresaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(tarefaEmpresa)))
            .andExpect(status().isMethodNotAllowed());
