...
class OpcaoRazaoSocialEmpresaResourceIT {
    ...
    void createOpcaoRazaoSocialEmpresa() throws Exception {
        ...
        OpcaoRazaoSocialEmpresaDTO opcaoRazaoSocialEmpresaDTO = opcaoRazaoSocialEmpresaMapper.toDto(opcaoRazaoSocialEmpresa);
        var returnedOpcaoRazaoSocialEmpresaDTO = om.readValue(
            restOpcaoRazaoSocialEmpresaMockMvc
                .perform(
                    post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(opcaoRazaoSocialEmpresaDTO))
                )
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            OpcaoRazaoSocialEmpresaDTO.class
        );

        // Validate the OpcaoRazaoSocialEmpresa in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedOpcaoRazaoSocialEmpresa = opcaoRazaoSocialEmpresaMapper.toEntity(returnedOpcaoRazaoSocialEmpresaDTO);
    ...
    void createOpcaoRazaoSocialEmpresaWithExistingId() throws Exception {
        ...
        restOpcaoRazaoSocialEmpresaMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(opcaoRazaoSocialEmpresaDTO)))
    ...
    void putExistingOpcaoRazaoSocialEmpresa() throws Exception {
        ...
        OpcaoRazaoSocialEmpresaDTO opcaoRazaoSocialEmpresaDTO = opcaoRazaoSocialEmpresaMapper.toDto(updatedOpcaoRazaoSocialEmpresa);

        restOpcaoRazaoSocialEmpresaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, opcaoRazaoSocialEmpresaDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(opcaoRazaoSocialEmpresaDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamOpcaoRazaoSocialEmpresa() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restOpcaoRazaoSocialEmpresaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(opcaoRazaoSocialEmpresaDTO)))
    ...
    void partialUpdateOpcaoRazaoSocialEmpresaWithPatch() throws Exception {
        ...
        partialUpdatedOpcaoRazaoSocialEmpresa.nome(UPDATED_NOME).selecionado(UPDATED_SELECIONADO);
    ...
    void patchNonExistingOpcaoRazaoSocialEmpresa() throws Exception {
        ...
        restOpcaoRazaoSocialEmpresaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, opcaoRazaoSocialEmpresaDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(opcaoRazaoSocialEmpresaDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamOpcaoRazaoSocialEmpresa() throws Exception {
        ...
        restOpcaoRazaoSocialEmpresaMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(opcaoRazaoSocialEmpresaDTO))
            )
            .andExpect(status().isMethodNotAllowed());
