...
class AvaliacaoResourceIT {
    ...
    void createAvaliacao() throws Exception {
        ...
        var returnedAvaliacaoDTO = om.readValue(
            restAvaliacaoMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(avaliacaoDTO)))
        ...
        var returnedAvaliacao = avaliacaoMapper.toEntity(returnedAvaliacaoDTO);
        ...
        restAvaliacaoMockMvc
            .perform(
                put(ENTITY_API_URL_ID, avaliacaoDTO.getId())
                    ...
                    .content(om.writeValueAsBytes(avaliacaoDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamAvaliacao() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAvaliacaoMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(avaliacaoDTO)))
    ...
    void patchWithMissingIdPathParamAvaliacao() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAvaliacaoMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(avaliacaoDTO)))
            .andExpect(status().isMethodNotAllowed());
