...
class AdicionalTributacaoResourceIT {
    ...
    void createAdicionalTributacao() throws Exception {
        ...
        var returnedAdicionalTributacao = om.readValue(
            restAdicionalTributacaoMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(adicionalTributacao)))
    ...
    void putWithMissingIdPathParamAdicionalTributacao() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAdicionalTributacaoMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(adicionalTributacao)))
    ...
    void patchWithMissingIdPathParamAdicionalTributacao() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAdicionalTributacaoMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(adicionalTributacao)))
            .andExpect(status().isMethodNotAllowed());
