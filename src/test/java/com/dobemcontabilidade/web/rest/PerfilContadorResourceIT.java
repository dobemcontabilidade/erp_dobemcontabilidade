...
class PerfilContadorResourceIT {
    ...
    void createPerfilContador() throws Exception {
        ...
        PerfilContadorDTO perfilContadorDTO = perfilContadorMapper.toDto(perfilContador);
        var returnedPerfilContadorDTO = om.readValue(
            restPerfilContadorMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(perfilContadorDTO)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            PerfilContadorDTO.class
        );

        // Validate the PerfilContador in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedPerfilContador = perfilContadorMapper.toEntity(returnedPerfilContadorDTO);
    ...
    @Test
    @Transactional
    void getAllPerfilContadorsByLimiteAreaContabilsIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedPerfilContador = perfilContadorRepository.saveAndFlush(perfilContador);

        // Get all the perfilContadorList where limiteAreaContabils equals to
        defaultPerfilContadorFiltering(
    ...
    @Test
    @Transactional
    void getAllPerfilContadorsByLimiteAreaContabilsIsInShouldWork() throws Exception {
        // Initialize the database
        insertedPerfilContador = perfilContadorRepository.saveAndFlush(perfilContador);

        // Get all the perfilContadorList where limiteAreaContabils in
        defaultPerfilContadorFiltering(
    ...
    @Test
    @Transactional
    void getAllPerfilContadorsByLimiteAreaContabilsIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedPerfilContador = perfilContadorRepository.saveAndFlush(perfilContador);

        // Get all the perfilContadorList where limiteAreaContabils is not null
        defaultPerfilContadorFiltering("limiteAreaContabils.specified=true", "limiteAreaContabils.specified=false");
    }

    @Test
    @Transactional
    void getAllPerfilContadorsByLimiteAreaContabilsIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedPerfilContador = perfilContadorRepository.saveAndFlush(perfilContador);

        // Get all the perfilContadorList where limiteAreaContabils is greater than or equal to
        defaultPerfilContadorFiltering(
    ...
    @Test
    @Transactional
    void getAllPerfilContadorsByLimiteAreaContabilsIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedPerfilContador = perfilContadorRepository.saveAndFlush(perfilContador);

        // Get all the perfilContadorList where limiteAreaContabils is less than or equal to
        defaultPerfilContadorFiltering(
    ...
    @Test
    @Transactional
    void getAllPerfilContadorsByLimiteAreaContabilsIsLessThanSomething() throws Exception {
        // Initialize the database
        insertedPerfilContador = perfilContadorRepository.saveAndFlush(perfilContador);

        // Get all the perfilContadorList where limiteAreaContabils is less than
        defaultPerfilContadorFiltering(
    ...
    @Test
    @Transactional
    void getAllPerfilContadorsByLimiteAreaContabilsIsGreaterThanSomething() throws Exception {
        // Initialize the database
        insertedPerfilContador = perfilContadorRepository.saveAndFlush(perfilContador);

        // Get all the perfilContadorList where limiteAreaContabils is greater than
        defaultPerfilContadorFiltering(
    ...
    void putExistingPerfilContador() throws Exception {
        ...
        updatedPerfilContador
            ...
            .limiteAreaContabils(UPDATED_LIMITE_AREA_CONTABILS)
            .limiteFaturamento(UPDATED_LIMITE_FATURAMENTO);
        PerfilContadorDTO perfilContadorDTO = perfilContadorMapper.toDto(updatedPerfilContador);

        restPerfilContadorMockMvc
            .perform(
                put(ENTITY_API_URL_ID, perfilContadorDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(perfilContadorDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamPerfilContador() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPerfilContadorMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(perfilContadorDTO)))
    ...
    void patchNonExistingPerfilContador() throws Exception {
        ...
        restPerfilContadorMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, perfilContadorDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(perfilContadorDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamPerfilContador() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPerfilContadorMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(perfilContadorDTO)))
            .andExpect(status().isMethodNotAllowed());
