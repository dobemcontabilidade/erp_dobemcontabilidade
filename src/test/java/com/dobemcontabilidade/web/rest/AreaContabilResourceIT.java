...
class AreaContabilResourceIT {
    ...
    public static AreaContabil createEntity(EntityManager em) {
        AreaContabil areaContabil = new AreaContabil().nome(DEFAULT_NOME).descricao(DEFAULT_DESCRICAO).percentual(DEFAULT_PERCENTUAL);
        return areaContabil;
    }
    ...
    public static AreaContabil createUpdatedEntity(EntityManager em) {
        AreaContabil areaContabil = new AreaContabil().nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).percentual(UPDATED_PERCENTUAL);
        return areaContabil;
    }
    ...
    void createAreaContabil() throws Exception {
        ...
        var returnedAreaContabil = om.readValue(
            restAreaContabilMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(areaContabil)))
    ...
    void putExistingAreaContabil() throws Exception {
        ...
        updatedAreaContabil.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).percentual(UPDATED_PERCENTUAL);

        restAreaContabilMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAreaContabil.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAreaContabil))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAreaContabil() throws Exception {
        ...
        restAreaContabilMockMvc
            .perform(
                put(ENTITY_API_URL_ID, areaContabil.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(areaContabil))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAreaContabil() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAreaContabilMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(areaContabil)))
    ...
    void partialUpdateAreaContabilWithPatch() throws Exception {
        ...
        partialUpdatedAreaContabil.descricao(UPDATED_DESCRICAO).percentual(UPDATED_PERCENTUAL);
    ...
    void fullUpdateAreaContabilWithPatch() throws Exception {
        ...
        partialUpdatedAreaContabil.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).percentual(UPDATED_PERCENTUAL);
    ...
    void patchNonExistingAreaContabil() throws Exception {
        ...
        restAreaContabilMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, areaContabil.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(areaContabil))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAreaContabil() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAreaContabilMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(areaContabil)))
            .andExpect(status().isMethodNotAllowed());
