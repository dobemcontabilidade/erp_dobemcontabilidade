...
class DepartamentoContadorResourceIT {
    ...
    void createDepartamentoContador() throws Exception {
        ...
        var returnedDepartamentoContador = om.readValue(
            restDepartamentoContadorMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(departamentoContador)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            DepartamentoContador.class
        );
    ...
    void putExistingDepartamentoContador() throws Exception {
        ...
        restDepartamentoContadorMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedDepartamentoContador.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedDepartamentoContador))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingDepartamentoContador() throws Exception {
        ...
        restDepartamentoContadorMockMvc
            .perform(
                put(ENTITY_API_URL_ID, departamentoContador.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(departamentoContador))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamDepartamentoContador() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restDepartamentoContadorMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(departamentoContador)))
    ...
    void patchNonExistingDepartamentoContador() throws Exception {
        ...
        restDepartamentoContadorMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, departamentoContador.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(departamentoContador))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamDepartamentoContador() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restDepartamentoContadorMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(departamentoContador)))
            .andExpect(status().isMethodNotAllowed());
