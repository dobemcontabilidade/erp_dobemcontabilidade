...
class OpcaoNomeFantasiaEmpresaResourceIT {
    ...
    void createOpcaoNomeFantasiaEmpresa() throws Exception {
        ...
        OpcaoNomeFantasiaEmpresaDTO opcaoNomeFantasiaEmpresaDTO = opcaoNomeFantasiaEmpresaMapper.toDto(opcaoNomeFantasiaEmpresa);
        var returnedOpcaoNomeFantasiaEmpresaDTO = om.readValue(
            restOpcaoNomeFantasiaEmpresaMockMvc
                .perform(
                    post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(opcaoNomeFantasiaEmpresaDTO))
                )
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            OpcaoNomeFantasiaEmpresaDTO.class
        );

        // Validate the OpcaoNomeFantasiaEmpresa in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedOpcaoNomeFantasiaEmpresa = opcaoNomeFantasiaEmpresaMapper.toEntity(returnedOpcaoNomeFantasiaEmpresaDTO);
    ...
    void putExistingOpcaoNomeFantasiaEmpresa() throws Exception {
        ...
        OpcaoNomeFantasiaEmpresaDTO opcaoNomeFantasiaEmpresaDTO = opcaoNomeFantasiaEmpresaMapper.toDto(updatedOpcaoNomeFantasiaEmpresa);

        restOpcaoNomeFantasiaEmpresaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, opcaoNomeFantasiaEmpresaDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(opcaoNomeFantasiaEmpresaDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamOpcaoNomeFantasiaEmpresa() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restOpcaoNomeFantasiaEmpresaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(opcaoNomeFantasiaEmpresaDTO)))
    ...
    void partialUpdateOpcaoNomeFantasiaEmpresaWithPatch() throws Exception {
        ...
        partialUpdatedOpcaoNomeFantasiaEmpresa.nome(UPDATED_NOME).ordem(UPDATED_ORDEM);
    ...
    void patchNonExistingOpcaoNomeFantasiaEmpresa() throws Exception {
        ...
        restOpcaoNomeFantasiaEmpresaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, opcaoNomeFantasiaEmpresaDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(opcaoNomeFantasiaEmpresaDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamOpcaoNomeFantasiaEmpresa() throws Exception {
        ...
        restOpcaoNomeFantasiaEmpresaMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(opcaoNomeFantasiaEmpresaDTO))
            )
            .andExpect(status().isMethodNotAllowed());
