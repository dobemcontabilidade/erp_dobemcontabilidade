...
class DescontoPlanoContabilResourceIT {
    ...
    void createDescontoPlanoContabil() throws Exception {
        ...
        var returnedDescontoPlanoContabil = om.readValue(
            restDescontoPlanoContabilMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(descontoPlanoContabil)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            DescontoPlanoContabil.class
        );
    ...
    void putExistingDescontoPlanoContabil() throws Exception {
        ...
        restDescontoPlanoContabilMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedDescontoPlanoContabil.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedDescontoPlanoContabil))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingDescontoPlanoContabil() throws Exception {
        ...
        restDescontoPlanoContabilMockMvc
            .perform(
                put(ENTITY_API_URL_ID, descontoPlanoContabil.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(descontoPlanoContabil))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamDescontoPlanoContabil() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restDescontoPlanoContabilMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(descontoPlanoContabil)))
    ...
    void patchNonExistingDescontoPlanoContabil() throws Exception {
        ...
        restDescontoPlanoContabilMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, descontoPlanoContabil.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(descontoPlanoContabil))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamDescontoPlanoContabil() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restDescontoPlanoContabilMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(descontoPlanoContabil)))
            .andExpect(status().isMethodNotAllowed());
