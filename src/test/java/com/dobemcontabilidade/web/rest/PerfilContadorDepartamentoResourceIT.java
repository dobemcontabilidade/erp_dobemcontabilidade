...
class PerfilContadorDepartamentoResourceIT {
    ...
    void createPerfilContadorDepartamento() throws Exception {
        ...
        PerfilContadorDepartamentoDTO perfilContadorDepartamentoDTO = perfilContadorDepartamentoMapper.toDto(perfilContadorDepartamento);
        var returnedPerfilContadorDepartamentoDTO = om.readValue(
            restPerfilContadorDepartamentoMockMvc
                .perform(
                    post(ENTITY_API_URL)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(om.writeValueAsBytes(perfilContadorDepartamentoDTO))
                )
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            PerfilContadorDepartamentoDTO.class
        );

        // Validate the PerfilContadorDepartamento in the database
        assertIncrementedRepositoryCount(databaseSizeBeforeCreate);
        var returnedPerfilContadorDepartamento = perfilContadorDepartamentoMapper.toEntity(returnedPerfilContadorDepartamentoDTO);
    ...
    void createPerfilContadorDepartamentoWithExistingId() throws Exception {
        ...
        restPerfilContadorDepartamentoMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(perfilContadorDepartamentoDTO))
            )
    ...
    void putExistingPerfilContadorDepartamento() throws Exception {
        ...
        updatedPerfilContadorDepartamento
            .quantidadeEmpresas(UPDATED_QUANTIDADE_EMPRESAS)
            .percentualExperiencia(UPDATED_PERCENTUAL_EXPERIENCIA);
        PerfilContadorDepartamentoDTO perfilContadorDepartamentoDTO = perfilContadorDepartamentoMapper.toDto(
            updatedPerfilContadorDepartamento
        );

        restPerfilContadorDepartamentoMockMvc
            .perform(
                put(ENTITY_API_URL_ID, perfilContadorDepartamentoDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(perfilContadorDepartamentoDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamPerfilContadorDepartamento() throws Exception {
        ...
        restPerfilContadorDepartamentoMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(perfilContadorDepartamentoDTO))
            )
    ...
    void patchNonExistingPerfilContadorDepartamento() throws Exception {
        ...
        restPerfilContadorDepartamentoMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, perfilContadorDepartamentoDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(perfilContadorDepartamentoDTO))
            )
            .andExpect(status().isBadRequest());
