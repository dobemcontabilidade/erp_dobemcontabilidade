...
class EnderecoPessoaResourceIT {
    ...
    void createEnderecoPessoa() throws Exception {
        ...
        EnderecoPessoaDTO enderecoPessoaDTO = enderecoPessoaMapper.toDto(enderecoPessoa);
        var returnedEnderecoPessoaDTO = om.readValue(
            restEnderecoPessoaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(enderecoPessoaDTO)))
        ...
        var returnedEnderecoPessoa = enderecoPessoaMapper.toEntity(returnedEnderecoPessoaDTO);
    ...
    void putExistingEnderecoPessoa() throws Exception {
        ...
        updatedEnderecoPessoa
            ...
            .cep(UPDATED_CEP)
            .principal(UPDATED_PRINCIPAL);
        EnderecoPessoaDTO enderecoPessoaDTO = enderecoPessoaMapper.toDto(updatedEnderecoPessoa);

        restEnderecoPessoaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, enderecoPessoaDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(enderecoPessoaDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamEnderecoPessoa() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restEnderecoPessoaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(enderecoPessoaDTO)))
    ...
    void patchNonExistingEnderecoPessoa() throws Exception {
        ...
        restEnderecoPessoaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, enderecoPessoaDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(enderecoPessoaDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamEnderecoPessoa() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restEnderecoPessoaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(enderecoPessoaDTO)))
            .andExpect(status().isMethodNotAllowed());
