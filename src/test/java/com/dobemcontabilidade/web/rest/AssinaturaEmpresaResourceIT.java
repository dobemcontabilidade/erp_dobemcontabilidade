...
class AssinaturaEmpresaResourceIT {
    ...
    @Test
    @Transactional
    void getAllAssinaturaEmpresasByRazaoSocialIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedAssinaturaEmpresa = assinaturaEmpresaRepository.saveAndFlush(assinaturaEmpresa);

        // Get all the assinaturaEmpresaList where razaoSocial equals to
        defaultAssinaturaEmpresaFiltering("razaoSocial.equals=" + DEFAULT_RAZAO_SOCIAL, "razaoSocial.equals=" + UPDATED_RAZAO_SOCIAL);
    }

    @Test
    @Transactional
    void getAllAssinaturaEmpresasByRazaoSocialIsInShouldWork() throws Exception {
        // Initialize the database
        insertedAssinaturaEmpresa = assinaturaEmpresaRepository.saveAndFlush(assinaturaEmpresa);

        // Get all the assinaturaEmpresaList where razaoSocial in
    ...
    @Test
    @Transactional
    void getAllAssinaturaEmpresasByRazaoSocialIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedAssinaturaEmpresa = assinaturaEmpresaRepository.saveAndFlush(assinaturaEmpresa);

        // Get all the assinaturaEmpresaList where razaoSocial is not null
        defaultAssinaturaEmpresaFiltering("razaoSocial.specified=true", "razaoSocial.specified=false");
    }

    @Test
    @Transactional
    void getAllAssinaturaEmpresasByRazaoSocialContainsSomething() throws Exception {
        // Initialize the database
        insertedAssinaturaEmpresa = assinaturaEmpresaRepository.saveAndFlush(assinaturaEmpresa);

        // Get all the assinaturaEmpresaList where razaoSocial contains
        defaultAssinaturaEmpresaFiltering("razaoSocial.contains=" + DEFAULT_RAZAO_SOCIAL, "razaoSocial.contains=" + UPDATED_RAZAO_SOCIAL);
    }

    @Test
    @Transactional
    void getAllAssinaturaEmpresasByRazaoSocialNotContainsSomething() throws Exception {
        // Initialize the database
        insertedAssinaturaEmpresa = assinaturaEmpresaRepository.saveAndFlush(assinaturaEmpresa);

        // Get all the assinaturaEmpresaList where razaoSocial does not contain
        defaultAssinaturaEmpresaFiltering(
