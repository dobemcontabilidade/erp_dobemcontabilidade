...
class AssinaturaEmpresaResourceIT {
    ...
    private static final SituacaoContratoEmpresaEnum DEFAULT_SITUACAO_CONTRATO_EMPRESA = SituacaoContratoEmpresaEnum.PROPOSTA;
    private static final SituacaoContratoEmpresaEnum UPDATED_SITUACAO_CONTRATO_EMPRESA = SituacaoContratoEmpresaEnum.ATIVO;

    private static final TipoContratoEnum DEFAULT_TIPO_CONTRATO = TipoContratoEnum.ABERTURAEMPRESA;
    private static final TipoContratoEnum UPDATED_TIPO_CONTRATO = TipoContratoEnum.CONTRATACAOPLANO;
    ...
    public static AssinaturaEmpresa createEntity(EntityManager em) {
        AssinaturaEmpresa assinaturaEmpresa = new AssinaturaEmpresa()
            ...
            .situacaoContratoEmpresa(DEFAULT_SITUACAO_CONTRATO_EMPRESA)
    ...
    public static AssinaturaEmpresa createUpdatedEntity(EntityManager em) {
        AssinaturaEmpresa assinaturaEmpresa = new AssinaturaEmpresa()
            ...
            .situacaoContratoEmpresa(UPDATED_SITUACAO_CONTRATO_EMPRESA)
    ...
    void createAssinaturaEmpresa() throws Exception {
        ...
        var returnedAssinaturaEmpresa = om.readValue(
            restAssinaturaEmpresaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(assinaturaEmpresa)))
    ...
    void getAllAssinaturaEmpresas() throws Exception {
        ...
        restAssinaturaEmpresaMockMvc
            ...
            .andExpect(jsonPath("$.[*].situacaoContratoEmpresa").value(hasItem(DEFAULT_SITUACAO_CONTRATO_EMPRESA.toString())))
    ...
    void getAssinaturaEmpresa() throws Exception {
        ...
        restAssinaturaEmpresaMockMvc
            ...
            .andExpect(jsonPath("$.situacaoContratoEmpresa").value(DEFAULT_SITUACAO_CONTRATO_EMPRESA.toString()))
    ...
    @Test
    @Transactional
    void getAllAssinaturaEmpresasBySituacaoContratoEmpresaIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedAssinaturaEmpresa = assinaturaEmpresaRepository.saveAndFlush(assinaturaEmpresa);

        // Get all the assinaturaEmpresaList where situacaoContratoEmpresa equals to
        defaultAssinaturaEmpresaFiltering(
            "situacaoContratoEmpresa.equals=" + DEFAULT_SITUACAO_CONTRATO_EMPRESA,
            "situacaoContratoEmpresa.equals=" + UPDATED_SITUACAO_CONTRATO_EMPRESA
        );
    }

    @Test
    @Transactional
    void getAllAssinaturaEmpresasBySituacaoContratoEmpresaIsInShouldWork() throws Exception {
        // Initialize the database
        insertedAssinaturaEmpresa = assinaturaEmpresaRepository.saveAndFlush(assinaturaEmpresa);

        // Get all the assinaturaEmpresaList where situacaoContratoEmpresa in
        defaultAssinaturaEmpresaFiltering(
            "situacaoContratoEmpresa.in=" + DEFAULT_SITUACAO_CONTRATO_EMPRESA + "," + UPDATED_SITUACAO_CONTRATO_EMPRESA,
            "situacaoContratoEmpresa.in=" + UPDATED_SITUACAO_CONTRATO_EMPRESA
        );
    }

    @Test
    @Transactional
    void getAllAssinaturaEmpresasBySituacaoContratoEmpresaIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedAssinaturaEmpresa = assinaturaEmpresaRepository.saveAndFlush(assinaturaEmpresa);

        // Get all the assinaturaEmpresaList where situacaoContratoEmpresa is not null
        defaultAssinaturaEmpresaFiltering("situacaoContratoEmpresa.specified=true", "situacaoContratoEmpresa.specified=false");
    }
    ...
    void putWithMissingIdPathParamAssinaturaEmpresa() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAssinaturaEmpresaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(assinaturaEmpresa)))
    ...
    void patchWithMissingIdPathParamAssinaturaEmpresa() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAssinaturaEmpresaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(assinaturaEmpresa)))
            .andExpect(status().isMethodNotAllowed());
