...
class PrazoAssinaturaResourceIT {
    ...
    void createPrazoAssinatura() throws Exception {
        ...
        var returnedPrazoAssinatura = om.readValue(
            restPrazoAssinaturaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(prazoAssinatura)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            PrazoAssinatura.class
        );
    ...
    void putExistingPrazoAssinatura() throws Exception {
        ...
        restPrazoAssinaturaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedPrazoAssinatura.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedPrazoAssinatura))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingPrazoAssinatura() throws Exception {
        ...
        restPrazoAssinaturaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, prazoAssinatura.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(prazoAssinatura))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamPrazoAssinatura() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPrazoAssinaturaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(prazoAssinatura)))
    ...
    void partialUpdatePrazoAssinaturaWithPatch() throws Exception {
        ...
        partialUpdatedPrazoAssinatura.meses(UPDATED_MESES);
    ...
    void patchNonExistingPrazoAssinatura() throws Exception {
        ...
        restPrazoAssinaturaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, prazoAssinatura.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(prazoAssinatura))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamPrazoAssinatura() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPrazoAssinaturaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(prazoAssinatura)))
            .andExpect(status().isMethodNotAllowed());
