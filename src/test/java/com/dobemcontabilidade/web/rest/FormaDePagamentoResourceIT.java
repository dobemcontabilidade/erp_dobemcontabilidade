...
class FormaDePagamentoResourceIT {
    ...
    void createFormaDePagamento() throws Exception {
        ...
        var returnedFormaDePagamento = om.readValue(
            restFormaDePagamentoMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(formaDePagamento)))
    ...
    void putWithMissingIdPathParamFormaDePagamento() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFormaDePagamentoMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(formaDePagamento)))
    ...
    void patchWithMissingIdPathParamFormaDePagamento() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFormaDePagamentoMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(formaDePagamento)))
            .andExpect(status().isMethodNotAllowed());
