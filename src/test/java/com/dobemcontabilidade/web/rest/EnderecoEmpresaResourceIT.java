...
class EnderecoEmpresaResourceIT {
    ...
    void createEnderecoEmpresa() throws Exception {
        ...
        var returnedEnderecoEmpresa = om.readValue(
            restEnderecoEmpresaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(enderecoEmpresa)))
    ...
    void putWithMissingIdPathParamEnderecoEmpresa() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restEnderecoEmpresaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(enderecoEmpresa)))
    ...
    void patchWithMissingIdPathParamEnderecoEmpresa() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restEnderecoEmpresaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(enderecoEmpresa)))
            .andExpect(status().isMethodNotAllowed());
