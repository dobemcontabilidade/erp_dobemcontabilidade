...
class PeriodoPagamentoResourceIT {
    ...
    void createPeriodoPagamento() throws Exception {
        ...
        var returnedPeriodoPagamento = om.readValue(
            restPeriodoPagamentoMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(periodoPagamento)))
    ...
    void putWithMissingIdPathParamPeriodoPagamento() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPeriodoPagamentoMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(periodoPagamento)))
    ...
    void partialUpdatePeriodoPagamentoWithPatch() throws Exception {
        ...
        partialUpdatedPeriodoPagamento.periodo(UPDATED_PERIODO);
    ...
    void patchWithMissingIdPathParamPeriodoPagamento() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPeriodoPagamentoMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(periodoPagamento)))
            .andExpect(status().isMethodNotAllowed());
