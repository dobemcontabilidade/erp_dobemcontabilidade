...
class TributacaoResourceIT {
    ...
    void createTributacao() throws Exception {
        ...
        TributacaoDTO tributacaoDTO = tributacaoMapper.toDto(tributacao);
        var returnedTributacaoDTO = om.readValue(
            restTributacaoMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(tributacaoDTO)))
        ...
        var returnedTributacao = tributacaoMapper.toEntity(returnedTributacaoDTO);
    ...
    void putExistingTributacao() throws Exception {
        ...
        TributacaoDTO tributacaoDTO = tributacaoMapper.toDto(updatedTributacao);

        restTributacaoMockMvc
            .perform(
                put(ENTITY_API_URL_ID, tributacaoDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(tributacaoDTO))
            )
            .andExpect(status().isOk());
    ...
    void putWithMissingIdPathParamTributacao() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTributacaoMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(tributacaoDTO)))
    ...
    void partialUpdateTributacaoWithPatch() throws Exception {
        ...
        partialUpdatedTributacao.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO);
    ...
    void patchNonExistingTributacao() throws Exception {
        ...
        restTributacaoMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, tributacaoDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(tributacaoDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamTributacao() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restTributacaoMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(tributacaoDTO)))
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteTributacao() throws Exception {
        ...
        restTributacaoMockMvc
            .perform(delete(ENTITY_API_URL_ID, tributacao.getId()).accept(MediaType.APPLICATION_JSON))
