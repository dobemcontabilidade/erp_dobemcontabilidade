...
class DepartamentoFuncionarioResourceIT {
    ...
    void createDepartamentoFuncionario() throws Exception {
        ...
        var returnedDepartamentoFuncionario = om.readValue(
            restDepartamentoFuncionarioMockMvc
                .perform(
                    post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(departamentoFuncionario))
                )
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            DepartamentoFuncionario.class
        );
    ...
    void createDepartamentoFuncionarioWithExistingId() throws Exception {
        ...
        restDepartamentoFuncionarioMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(departamentoFuncionario)))
    ...
    void putExistingDepartamentoFuncionario() throws Exception {
        ...
        restDepartamentoFuncionarioMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedDepartamentoFuncionario.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedDepartamentoFuncionario))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingDepartamentoFuncionario() throws Exception {
        ...
        restDepartamentoFuncionarioMockMvc
            .perform(
                put(ENTITY_API_URL_ID, departamentoFuncionario.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(departamentoFuncionario))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamDepartamentoFuncionario() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restDepartamentoFuncionarioMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(departamentoFuncionario)))
    ...
    void patchNonExistingDepartamentoFuncionario() throws Exception {
        ...
        restDepartamentoFuncionarioMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, departamentoFuncionario.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(departamentoFuncionario))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamDepartamentoFuncionario() throws Exception {
        ...
        restDepartamentoFuncionarioMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(departamentoFuncionario))
            )
            .andExpect(status().isMethodNotAllowed());
