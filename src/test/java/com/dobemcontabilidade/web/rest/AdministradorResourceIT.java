...
class AdministradorResourceIT {
    ...
    public static Administrador createEntity(EntityManager em) {
        Administrador administrador = new Administrador().nome(DEFAULT_NOME).sobreNome(DEFAULT_SOBRE_NOME).funcao(DEFAULT_FUNCAO);
        // Add required entity
        Pessoa pessoa;
    ...
    public static Administrador createUpdatedEntity(EntityManager em) {
        Administrador administrador = new Administrador().nome(UPDATED_NOME).sobreNome(UPDATED_SOBRE_NOME).funcao(UPDATED_FUNCAO);
        // Add required entity
        Pessoa pessoa;
        if (TestUtil.findAll(em, Pessoa.class).isEmpty()) {
    ...
    void putExistingAdministrador() throws Exception {
        ...
        updatedAdministrador.nome(UPDATED_NOME).sobreNome(UPDATED_SOBRE_NOME).funcao(UPDATED_FUNCAO);
    ...
    void partialUpdateAdministradorWithPatch() throws Exception {
        ...
        partialUpdatedAdministrador.nome(UPDATED_NOME).funcao(UPDATED_FUNCAO);
    ...
    void fullUpdateAdministradorWithPatch() throws Exception {
        ...
        partialUpdatedAdministrador.nome(UPDATED_NOME).sobreNome(UPDATED_SOBRE_NOME).funcao(UPDATED_FUNCAO);
