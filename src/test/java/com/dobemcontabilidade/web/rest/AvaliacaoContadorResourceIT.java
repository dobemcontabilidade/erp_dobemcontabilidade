...
class AvaliacaoContadorResourceIT {
    ...
    void createAvaliacaoContador() throws Exception {
        ...
        var returnedAvaliacaoContador = om.readValue(
            restAvaliacaoContadorMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(avaliacaoContador)))
                .andExpect(status().isCreated())
                .andReturn()
                .getResponse()
                .getContentAsString(),
            AvaliacaoContador.class
        );
    ...
    void putExistingAvaliacaoContador() throws Exception {
        ...
        restAvaliacaoContadorMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedAvaliacaoContador.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedAvaliacaoContador))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingAvaliacaoContador() throws Exception {
        ...
        restAvaliacaoContadorMockMvc
            .perform(
                put(ENTITY_API_URL_ID, avaliacaoContador.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(avaliacaoContador))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamAvaliacaoContador() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAvaliacaoContadorMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(avaliacaoContador)))
    ...
    void patchNonExistingAvaliacaoContador() throws Exception {
        ...
        restAvaliacaoContadorMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, avaliacaoContador.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(avaliacaoContador))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamAvaliacaoContador() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restAvaliacaoContadorMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(avaliacaoContador)))
            .andExpect(status().isMethodNotAllowed());
