...
class FrequenciaResourceIT {
    ...
    public static Frequencia createEntity(EntityManager em) {
        Frequencia frequencia = new Frequencia().nome(DEFAULT_NOME).descricao(DEFAULT_DESCRICAO).numeroDias(DEFAULT_NUMERO_DIAS);
        return frequencia;
    }
    ...
    public static Frequencia createUpdatedEntity(EntityManager em) {
        Frequencia frequencia = new Frequencia().nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).numeroDias(UPDATED_NUMERO_DIAS);
        return frequencia;
    }
    ...
    void createFrequencia() throws Exception {
        ...
        var returnedFrequencia = om.readValue(
            restFrequenciaMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(frequencia)))
    ...
    void putExistingFrequencia() throws Exception {
        ...
        updatedFrequencia.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).numeroDias(UPDATED_NUMERO_DIAS);

        restFrequenciaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedFrequencia.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(updatedFrequencia))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingFrequencia() throws Exception {
        ...
        restFrequenciaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, frequencia.getId()).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(frequencia))
            )
            .andExpect(status().isBadRequest());
        ...
        restFrequenciaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, longCount.incrementAndGet())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(om.writeValueAsBytes(frequencia))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamFrequencia() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFrequenciaMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(frequencia)))
    ...
    void partialUpdateFrequenciaWithPatch() throws Exception {
        ...
        partialUpdatedFrequencia.descricao(UPDATED_DESCRICAO).numeroDias(UPDATED_NUMERO_DIAS);
    ...
    void fullUpdateFrequenciaWithPatch() throws Exception {
        ...
        partialUpdatedFrequencia.nome(UPDATED_NOME).descricao(UPDATED_DESCRICAO).numeroDias(UPDATED_NUMERO_DIAS);
    ...
    void patchNonExistingFrequencia() throws Exception {
        ...
        restFrequenciaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, frequencia.getId())
                    .contentType("application/merge-patch+json")
                    .content(om.writeValueAsBytes(frequencia))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamFrequencia() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restFrequenciaMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(frequencia)))
            .andExpect(status().isMethodNotAllowed());
