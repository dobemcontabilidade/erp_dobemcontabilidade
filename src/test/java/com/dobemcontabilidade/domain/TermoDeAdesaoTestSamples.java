...
public class TermoDeAdesaoTestSamples {
    ...
    public static TermoDeAdesao getTermoDeAdesaoSample1() {
        return new TermoDeAdesao().id(1L).titulo("titulo1").urlDoc("urlDoc1");
    }

    public static TermoDeAdesao getTermoDeAdesaoSample2() {
        return new TermoDeAdesao().id(2L).titulo("titulo2").urlDoc("urlDoc2");
    }

    public static TermoDeAdesao getTermoDeAdesaoRandomSampleGenerator() {
        return new TermoDeAdesao()
            .id(longCount.incrementAndGet())
            .titulo(UUID.randomUUID().toString())
            .urlDoc(UUID.randomUUID().toString());
    }
}
