...
class RamoTest {
    ...
    void anexoRequeridoEmpresaTest() {
        ...
        ramo.addAnexoRequeridoEmpresa(anexoRequeridoEmpresaBack);
        assertThat(ramo.getAnexoRequeridoEmpresas()).containsOnly(anexoRequeridoEmpresaBack);
        assertThat(anexoRequeridoEmpresaBack.getRamo()).isEqualTo(ramo);

        ramo.removeAnexoRequeridoEmpresa(anexoRequeridoEmpresaBack);
        assertThat(ramo.getAnexoRequeridoEmpresas()).doesNotContain(anexoRequeridoEmpresaBack);
        assertThat(anexoRequeridoEmpresaBack.getRamo()).isNull();

        ramo.anexoRequeridoEmpresas(new HashSet<>(Set.of(anexoRequeridoEmpresaBack)));
        assertThat(ramo.getAnexoRequeridoEmpresas()).containsOnly(anexoRequeridoEmpresaBack);
        assertThat(anexoRequeridoEmpresaBack.getRamo()).isEqualTo(ramo);

        ramo.setAnexoRequeridoEmpresas(new HashSet<>());
        assertThat(ramo.getAnexoRequeridoEmpresas()).doesNotContain(anexoRequeridoEmpresaBack);
        assertThat(anexoRequeridoEmpresaBack.getRamo()).isNull();
    }
    ...
    void empresaModeloTest() {
        ...
        ramo.addEmpresaModelo(empresaModeloBack);
        assertThat(ramo.getEmpresaModelos()).containsOnly(empresaModeloBack);
        assertThat(empresaModeloBack.getRamo()).isEqualTo(ramo);

        ramo.removeEmpresaModelo(empresaModeloBack);
        assertThat(ramo.getEmpresaModelos()).doesNotContain(empresaModeloBack);
        assertThat(empresaModeloBack.getRamo()).isNull();

        ramo.empresaModelos(new HashSet<>(Set.of(empresaModeloBack)));
        assertThat(ramo.getEmpresaModelos()).containsOnly(empresaModeloBack);
        assertThat(empresaModeloBack.getRamo()).isEqualTo(ramo);

        ramo.setEmpresaModelos(new HashSet<>());
        assertThat(ramo.getEmpresaModelos()).doesNotContain(empresaModeloBack);
        assertThat(empresaModeloBack.getRamo()).isNull();
    }
