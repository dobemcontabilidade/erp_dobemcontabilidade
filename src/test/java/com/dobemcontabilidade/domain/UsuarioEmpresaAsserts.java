...
public class UsuarioEmpresaAsserts {
    ...
    public static void assertUsuarioEmpresaUpdatableFieldsEquals(UsuarioEmpresa expected, UsuarioEmpresa actual) {
        assertThat(expected)
            ...
            .satisfies(
                e ->
                    assertThat(e.getSituacaoUsuarioEmpresa())
                        .as("check situacaoUsuarioEmpresa")
                        .isEqualTo(actual.getSituacaoUsuarioEmpresa())
            )
            .satisfies(
                e ->
                    assertThat(e.getTipoUsuarioEmpresaEnum())
                        .as("check tipoUsuarioEmpresaEnum")
                        .isEqualTo(actual.getTipoUsuarioEmpresaEnum())
            );
    }
