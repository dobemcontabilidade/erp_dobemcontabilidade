...
class FormaDePagamentoTest {
    ...
    void cobrancaEmpresaTest() {
        ...
        formaDePagamento.addCobrancaEmpresa(cobrancaEmpresaBack);
        assertThat(formaDePagamento.getCobrancaEmpresas()).containsOnly(cobrancaEmpresaBack);
        assertThat(cobrancaEmpresaBack.getFormaDePagamento()).isEqualTo(formaDePagamento);

        formaDePagamento.removeCobrancaEmpresa(cobrancaEmpresaBack);
        assertThat(formaDePagamento.getCobrancaEmpresas()).doesNotContain(cobrancaEmpresaBack);
        assertThat(cobrancaEmpresaBack.getFormaDePagamento()).isNull();

        formaDePagamento.cobrancaEmpresas(new HashSet<>(Set.of(cobrancaEmpresaBack)));
        assertThat(formaDePagamento.getCobrancaEmpresas()).containsOnly(cobrancaEmpresaBack);
        assertThat(cobrancaEmpresaBack.getFormaDePagamento()).isEqualTo(formaDePagamento);

        formaDePagamento.setCobrancaEmpresas(new HashSet<>());
        assertThat(formaDePagamento.getCobrancaEmpresas()).doesNotContain(cobrancaEmpresaBack);
        assertThat(cobrancaEmpresaBack.getFormaDePagamento()).isNull();
    }
}
