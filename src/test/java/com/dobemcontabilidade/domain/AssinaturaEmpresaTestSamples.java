...
public class AssinaturaEmpresaTestSamples {
    ...
    public static AssinaturaEmpresa getAssinaturaEmpresaSample1() {
        return new AssinaturaEmpresa().id(1L).razaoSocial("razaoSocial1").codigoAssinatura("codigoAssinatura1").diaVencimento(1);
    }

    public static AssinaturaEmpresa getAssinaturaEmpresaSample2() {
        return new AssinaturaEmpresa().id(2L).razaoSocial("razaoSocial2").codigoAssinatura("codigoAssinatura2").diaVencimento(2);
    }
