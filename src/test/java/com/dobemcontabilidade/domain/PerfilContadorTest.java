...
class PerfilContadorTest {
    ...
    void perfilContadorAreaContabilTest() {
        ...
        perfilContador.addPerfilContadorAreaContabil(perfilContadorAreaContabilBack);
        assertThat(perfilContador.getPerfilContadorAreaContabils()).containsOnly(perfilContadorAreaContabilBack);
        assertThat(perfilContadorAreaContabilBack.getPerfilContador()).isEqualTo(perfilContador);

        perfilContador.removePerfilContadorAreaContabil(perfilContadorAreaContabilBack);
        assertThat(perfilContador.getPerfilContadorAreaContabils()).doesNotContain(perfilContadorAreaContabilBack);
        assertThat(perfilContadorAreaContabilBack.getPerfilContador()).isNull();

        perfilContador.perfilContadorAreaContabils(new HashSet<>(Set.of(perfilContadorAreaContabilBack)));
        assertThat(perfilContador.getPerfilContadorAreaContabils()).containsOnly(perfilContadorAreaContabilBack);
        assertThat(perfilContadorAreaContabilBack.getPerfilContador()).isEqualTo(perfilContador);

        perfilContador.setPerfilContadorAreaContabils(new HashSet<>());
        assertThat(perfilContador.getPerfilContadorAreaContabils()).doesNotContain(perfilContadorAreaContabilBack);
        assertThat(perfilContadorAreaContabilBack.getPerfilContador()).isNull();
    }
