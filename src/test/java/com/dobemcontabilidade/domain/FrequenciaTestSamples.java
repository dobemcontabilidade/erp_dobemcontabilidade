...
public class FrequenciaTestSamples {
    ...
    public static Frequencia getFrequenciaSample1() {
        return new Frequencia().id(1L).nome("nome1").prioridade("prioridade1").numeroDias(1);
    }

    public static Frequencia getFrequenciaSample2() {
        return new Frequencia().id(2L).nome("nome2").prioridade("prioridade2").numeroDias(2);
    }
    ...
    public static Frequencia getFrequenciaRandomSampleGenerator() {
        return new Frequencia()
            ...
            .prioridade(UUID.randomUUID().toString())
