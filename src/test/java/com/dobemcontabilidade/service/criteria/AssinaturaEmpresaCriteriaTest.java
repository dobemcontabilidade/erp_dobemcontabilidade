...
class AssinaturaEmpresaCriteriaTest {
    ...
    private static void setAllFilters(AssinaturaEmpresaCriteria assinaturaEmpresaCriteria) {
        ...
        assinaturaEmpresaCriteria.situacaoContratoEmpresa();
        assinaturaEmpresaCriteria.tipoContrato();
        assinaturaEmpresaCriteria.grupoAcessoEmpresaId();
        assinaturaEmpresaCriteria.areaContabilAssinaturaEmpresaId();
        assinaturaEmpresaCriteria.servicoContabilAssinaturaEmpresaId();
        assinaturaEmpresaCriteria.gatewayAssinaturaEmpresaId();
        assinaturaEmpresaCriteria.calculoPlanoAssinaturaId();
        assinaturaEmpresaCriteria.pagamentoId();
        assinaturaEmpresaCriteria.cobrancaEmpresaId();
        assinaturaEmpresaCriteria.usuarioEmpresaId();
    ...
    private static Condition<AssinaturaEmpresaCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getSituacaoContratoEmpresa()) &&
                condition.apply(criteria.getTipoContrato()) &&
                condition.apply(criteria.getGrupoAcessoEmpresaId()) &&
                condition.apply(criteria.getAreaContabilAssinaturaEmpresaId()) &&
                condition.apply(criteria.getServicoContabilAssinaturaEmpresaId()) &&
                condition.apply(criteria.getGatewayAssinaturaEmpresaId()) &&
                condition.apply(criteria.getCalculoPlanoAssinaturaId()) &&
                condition.apply(criteria.getPagamentoId()) &&
                condition.apply(criteria.getCobrancaEmpresaId()) &&
    ...
    private static Condition<AssinaturaEmpresaCriteria> copyFiltersAre(
        ...
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getSituacaoContratoEmpresa(), copy.getSituacaoContratoEmpresa()) &&
                condition.apply(criteria.getTipoContrato(), copy.getTipoContrato()) &&
                condition.apply(criteria.getGrupoAcessoEmpresaId(), copy.getGrupoAcessoEmpresaId()) &&
                condition.apply(criteria.getAreaContabilAssinaturaEmpresaId(), copy.getAreaContabilAssinaturaEmpresaId()) &&
                condition.apply(criteria.getServicoContabilAssinaturaEmpresaId(), copy.getServicoContabilAssinaturaEmpresaId()) &&
                condition.apply(criteria.getGatewayAssinaturaEmpresaId(), copy.getGatewayAssinaturaEmpresaId()) &&
                ...
                condition.apply(criteria.getCobrancaEmpresaId(), copy.getCobrancaEmpresaId()) &&
