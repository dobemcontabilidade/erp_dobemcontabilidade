...
class UsuarioContadorCriteriaTest {
    ...
    private static void setAllFilters(UsuarioContadorCriteria usuarioContadorCriteria) {
        ...
        usuarioContadorCriteria.ativo();
        usuarioContadorCriteria.dataHoraAtivacao();
        usuarioContadorCriteria.dataLimiteAcesso();
        usuarioContadorCriteria.situacao();
        usuarioContadorCriteria.grupoAcessoEmpresaUsuarioContadorId();
        usuarioContadorCriteria.grupoAcessoUsuarioContadorId();
        usuarioContadorCriteria.feedBackUsuarioParaContadorId();
    ...
    private static Condition<UsuarioContadorCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getGrupoAcessoEmpresaUsuarioContadorId()) &&
                condition.apply(criteria.getGrupoAcessoUsuarioContadorId()) &&
    ...
    private static Condition<UsuarioContadorCriteria> copyFiltersAre(
        ...
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getGrupoAcessoEmpresaUsuarioContadorId(), copy.getGrupoAcessoEmpresaUsuarioContadorId()) &&
                condition.apply(criteria.getGrupoAcessoUsuarioContadorId(), copy.getGrupoAcessoUsuarioContadorId()) &&
