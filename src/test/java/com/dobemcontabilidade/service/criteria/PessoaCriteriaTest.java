...
class PessoaCriteriaTest {
    ...
    private static void setAllFilters(PessoaCriteria pessoaCriteria) {
        ...
        pessoaCriteria.rg();
        pessoaCriteria.rgOrgaoExpeditor();
        pessoaCriteria.rgUfExpedicao();
        pessoaCriteria.nomeMae();
        pessoaCriteria.nomePai();
        pessoaCriteria.localNascimento();
        pessoaCriteria.racaECor();
        pessoaCriteria.pessoaComDeficiencia();
        pessoaCriteria.estadoCivil();
        pessoaCriteria.sexo();
        pessoaCriteria.urlFotoPerfil();
        pessoaCriteria.funcionarioId();
        pessoaCriteria.anexoPessoaId();
        pessoaCriteria.escolaridadePessoaId();
        pessoaCriteria.bancoPessoaId();
        pessoaCriteria.dependentesFuncionarioId();
    ...
    private static Condition<PessoaCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getRgOrgaoExpeditor()) &&
                condition.apply(criteria.getRgUfExpedicao()) &&
                condition.apply(criteria.getNomeMae()) &&
                condition.apply(criteria.getNomePai()) &&
                condition.apply(criteria.getLocalNascimento()) &&
                condition.apply(criteria.getRacaECor()) &&
                condition.apply(criteria.getPessoaComDeficiencia()) &&
                ...
                condition.apply(criteria.getEscolaridadePessoaId()) &&
                condition.apply(criteria.getBancoPessoaId()) &&
    ...
    private static Condition<PessoaCriteria> copyFiltersAre(PessoaCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getRgOrgaoExpeditor(), copy.getRgOrgaoExpeditor()) &&
                condition.apply(criteria.getRgUfExpedicao(), copy.getRgUfExpedicao()) &&
                condition.apply(criteria.getNomeMae(), copy.getNomeMae()) &&
                condition.apply(criteria.getNomePai(), copy.getNomePai()) &&
                condition.apply(criteria.getLocalNascimento(), copy.getLocalNascimento()) &&
                condition.apply(criteria.getRacaECor(), copy.getRacaECor()) &&
                condition.apply(criteria.getPessoaComDeficiencia(), copy.getPessoaComDeficiencia()) &&
                ...
                condition.apply(criteria.getEscolaridadePessoaId(), copy.getEscolaridadePessoaId()) &&
                condition.apply(criteria.getBancoPessoaId(), copy.getBancoPessoaId()) &&
