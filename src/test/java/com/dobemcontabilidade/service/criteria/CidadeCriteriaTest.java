...
class CidadeCriteriaTest {
    ...
    private static void setAllFilters(CidadeCriteria cidadeCriteria) {
        ...
        cidadeCriteria.instituicaoEnsinoId();
        cidadeCriteria.agenteIntegracaoEstagioId();
        cidadeCriteria.empresaModeloId();
        cidadeCriteria.fluxoModeloId();
    ...
    private static Condition<CidadeCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getInstituicaoEnsinoId()) &&
                condition.apply(criteria.getAgenteIntegracaoEstagioId()) &&
                condition.apply(criteria.getEmpresaModeloId()) &&
                condition.apply(criteria.getFluxoModeloId()) &&
    ...
    private static Condition<CidadeCriteria> copyFiltersAre(CidadeCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getInstituicaoEnsinoId(), copy.getInstituicaoEnsinoId()) &&
                condition.apply(criteria.getAgenteIntegracaoEstagioId(), copy.getAgenteIntegracaoEstagioId()) &&
                condition.apply(criteria.getEmpresaModeloId(), copy.getEmpresaModeloId()) &&
                condition.apply(criteria.getFluxoModeloId(), copy.getFluxoModeloId()) &&
